...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with versionRef 'guava'.
        ...
        /**
         * Creates a dependency provider for guessencoding (org.codehaus.guessencoding:guessencoding)
     * with versionRef 'guessencoding'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGuessencoding() {
            return create("guessencoding");
    }

        /**
         * Creates a dependency provider for inject (javax.inject:javax.inject)
     * with versionRef 'inject'.
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Creates a dependency provider for jacksonCSV (com.fasterxml.jackson.dataformat:jackson-dataformat-csv)
     * with versionRef 'jackson'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJacksonCSV() {
            return create("jacksonCSV");
    }

        /**
         * Creates a dependency provider for javaWs (javax.jws:javax.jws-api)
     * with versionRef 'javaWs'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJavaWs() {
            return create("javaWs");
    }

        /**
         * Creates a dependency provider for jaxrs (javax.ws.rs:javax.ws.rs-api)
     * with versionRef 'jaxrs'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJaxrs() {
            return create("jaxrs");
    }

        /**
         * Creates a dependency provider for jersey (org.glassfish.jersey.core:jersey-client)
     * with versionRef 'jersey'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJersey() {
            return create("jersey");
    }
     ...
     * with versionRef 'junitJupiter'.
        ...
        /**
         * Creates a dependency provider for owaspEncoder (org.owasp.encoder:encoder)
     * with versionRef 'owaspEncoder'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getOwaspEncoder() {
            return create("owaspEncoder");
    }

        /**
         * Creates a dependency provider for servlet (javax.servlet:javax.servlet-api)
     * with versionRef 'servlet'.
         * This dependency was declared in catalog libs.versions.toml
         */
     ...
     * with versionRef 'slf4j'.
        ...
        /**
         * Creates a dependency provider for spring (org.springframework:spring-core)
     * with versionRef 'spring'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSpring() {
            return create("spring");
    }

        /**
         * Creates a dependency provider for swaggercore (io.swagger.core.v3:swagger-core)
     * with versionRef 'swaggercore'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSwaggercore() {
            return create("swaggercore");
    }

        /**
         * Creates a dependency provider for swaggerjaxrs2 (io.swagger.core.v3:swagger-jaxrs2)
     * with versionRef 'swaggerjaxrs2'.
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSwaggerjaxrs2() {
            return create("swaggerjaxrs2");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: annotation (1.3.2)
            ...
            /**
             * Returns the version associated to this alias: guava (31.1-jre)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: guessencoding (1.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGuessencoding() { return getVersion("guessencoding"); }
            ...
            /**
             * Returns the version associated to this alias: jackson (2.15.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: javaWs (1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJavaWs() { return getVersion("javaWs"); }

            /**
             * Returns the version associated to this alias: jaxrs (2.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJaxrs() { return getVersion("jaxrs"); }

            /**
             * Returns the version associated to this alias: jersey (2.40)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: junitJupiter (5.9.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: owaspEncoder (1.2.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getOwaspEncoder() { return getVersion("owaspEncoder"); }
            ...
            /**
             * Returns the version associated to this alias: swaggercore (2.2.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: swaggerjaxrs2 (2.2.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSwaggerjaxrs2() { return getVersion("swaggerjaxrs2"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        public BundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }
            ...
            /**
             * Creates a dependency bundle provider for jersey which is an aggregate for the following dependencies:
             * <ul>
             *    <li>org.glassfish.jersey.core:jersey-client</li>
             *    <li>javax.ws.rs:javax.ws.rs-api</li>
             * </ul>
             * This bundle was declared in catalog libs.versions.toml
             */
            public Provider<ExternalModuleDependencyBundle> getJersey() {
                return createBundle("jersey");
            }
             ...
             * This bundle was declared in catalog libs.versions.toml
             */
            public Provider<ExternalModuleDependencyBundle> getSpring() {
