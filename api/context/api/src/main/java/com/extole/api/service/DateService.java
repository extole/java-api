...
public interface DateService {
    ...
    String toTimezone(String dateTime, String format, String timezone)
        throws InvalidDateException, InvalidTimezoneException;

    String toClientTimezone(String dateTime, String format) throws InvalidDateException, InvalidTimezoneException;
