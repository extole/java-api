...
public class ExtendableComponentBuildtimeContextImpl implements ComponentBuildtimeContext, ShortVariableSyntaxContext {
    private final ComponentBuildtimeContext context;

    public ExtendableComponentBuildtimeContextImpl(ComponentBuildtimeContext context) {
