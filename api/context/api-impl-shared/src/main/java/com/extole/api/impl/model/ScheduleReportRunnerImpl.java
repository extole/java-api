...
import com.extole.api.model.ScheduleReportRunner;
import com.extole.reporting.pojo.report.runner.ScheduledReportRunnerPojo;

public final class ScheduleReportRunnerImpl implements ScheduleReportRunner {

    private final ScheduledReportRunnerPojo reportRunner;

    public ScheduleReportRunnerImpl(ScheduledReportRunnerPojo reportRunner) {
    ...
    public String getFrequency() {
        return reportRunner.getFrequency().name();
    }

    @Override
    public String getScheduleStartDate() {
        return reportRunner.getScheduleStartDate().toString();
    }

    @Override
    public boolean isLegacySftpReportNameFormat() {
        return reportRunner.isLegacySftpReportNameFormat();
    }
