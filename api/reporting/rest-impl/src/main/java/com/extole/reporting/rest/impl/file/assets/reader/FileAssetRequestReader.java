package com.extole.reporting.rest.impl.file.assets.reader;
...
public final class FileAssetRequestReader implements MessageBodyReader<FileAssetRequest> {
    ...
    public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return type == FileAssetRequest.class;
    }

    @Override
    public FileAssetRequest readFrom(Class<FileAssetRequest> type, Type genericType,
        ...
        FileAssetMetadata metadataRequest = null;
        if (metadata != null) {
            metadata.setMediaType(MediaType.APPLICATION_JSON_TYPE);
            metadataRequest = metadata.getValueAs(FileAssetMetadata.class);
        }
        ...
        return new FileAssetRequest(metadataRequest, fileInputStreamRequest);
    }
}
