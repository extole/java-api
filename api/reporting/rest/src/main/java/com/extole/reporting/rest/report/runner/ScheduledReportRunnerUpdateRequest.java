...
public class ScheduledReportRunnerUpdateRequest extends ReportRunnerUpdateRequest {
    ...
    public ScheduledReportRunnerUpdateRequest(
        ...
        @Parameter(
            description = "First date of the report runner execution. Must be present for create operation.") @JsonProperty(JSON_SCHEDULE_START_DATE) Omissible<
                ZonedDateTime> scheduleStartDate,
        @Parameter(
