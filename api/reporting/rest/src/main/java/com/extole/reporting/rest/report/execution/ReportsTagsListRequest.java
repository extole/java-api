...
public class ReportsTagsListRequest {
    ...
    public ReportsTagsListRequest(
        ...
        @Parameter(deprecated = true, description = "Optional filter for exclude tags, " +
    ...
    public static final class Builder {
        ...
        public ReportsTagsListRequest build() {
            return new ReportsTagsListRequest(havingAnyTags, excludeHavingAnyTags, tags, excludeTags, offset, limit);
        }
    }
}
