...
public class SparkReportTypeResponse extends ReportTypeResponse {

    @JsonCreator
    public SparkReportTypeResponse(
        ...
        super(ReportType.SPARK, name, displayName, description, executorType, categories, scopes, visibility,
    ...
    public static final class Builder extends ReportTypeResponse.Builder {
        ...
        public SparkReportTypeResponse build() {
            return new SparkReportTypeResponse(name, displayName, description, executorType, categories, scopes,
