...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY,
    property = ReportRunnerUpdateRequest.JSON_TYPE)
@JsonSubTypes({
    @JsonSubTypes.Type(value = ScheduledReportRunnerUpdateRequest.class, name = "SCHEDULED"),
    @JsonSubTypes.Type(value = RefreshingReportRunnerUpdateRequest.class, name = "REFRESHING")
})
public abstract class ReportRunnerUpdateRequest {
    ...
    private final Omissible<String> reportType;
    ...
    public ReportRunnerUpdateRequest(
        ReportRunnerType type,
        Omissible<String> name,
        Omissible<String> reportType,
    ...
    public Omissible<String> getReportType() {
        return reportType;
    }
    ...
    public static class Builder<T> {
        ...
        protected Omissible<String> reportType = Omissible.omitted();
        ...
        public T withReportType(String reportType) {
            this.reportType = Omissible.of(reportType);
            return (T) this;
        }
