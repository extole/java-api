...
public class RefreshingReportRunnerCreateRequest extends ReportRunnerCreateRequest {

    private static final String JSON_EXPIRATION_MS = "expiration_ms";

    private final Omissible<Long> expirationMs;

    public RefreshingReportRunnerCreateRequest(
    ...
    public static final class Builder extends ReportRunnerCreateRequest.Builder<Builder> {
        ...
        public RefreshingReportRunnerCreateRequest build() {
            return new RefreshingReportRunnerCreateRequest(name, reportType, formats, parameters, tags, scopes,
