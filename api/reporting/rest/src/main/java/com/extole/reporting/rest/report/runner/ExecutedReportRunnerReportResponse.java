...
public class ExecutedReportRunnerReportResponse extends BaseReportRunnerReportResponse {
    public static final String TYPE = "EXECUTED";
    ...
    @JsonCreator
    public ExecutedReportRunnerReportResponse(
    ...
    public static final class Builder extends BaseReportRunnerReportResponse.Builder {
        ...
        public Builder withStatus(ReportSlotStatus status) {
            this.status = status;
            return this;
        }

        public ExecutedReportRunnerReportResponse build() {
            return new ExecutedReportRunnerReportResponse(reportId, reportType, reportType, displayName, executorType,
                format, formats, userId, parameters, tags, createdDate, startedDate, completedDate, errorCode,
                downloadUri, sftpReportName, visible, scopes, sftpServerId, slot, status);
        }
    }
}
