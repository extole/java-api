...
public class ScheduledReportRunnerCreateRequest extends ReportRunnerCreateRequest {
    ...
    public ScheduledReportRunnerCreateRequest(
        @Parameter(description = "Display name of the report runner. Has to be unique for client. " +
            "Must be present for create operation.") @JsonProperty(JSON_NAME) String name,
        @Parameter(
            description = "Report type name of the report runner. Must be present for create operation.") @JsonProperty(JSON_REPORT_TYPE) String reportType,
        ...
        @Parameter(
            description = "Frequency of the report runner execution. Must be present for create operation.") @JsonProperty(JSON_FREQUENCY) Omissible<
                ScheduleFrequency> frequency,
        @Parameter(
            description = "First date of the report runner execution. Must be present for create operation.") @JsonProperty(JSON_SCHEDULE_START_DATE) ZonedDateTime scheduleStartDate,
        @Parameter(
            description = "Optional flag to generate SFTP report name in the legacy format.") @JsonProperty(JSON_LEGACY_SFTP_REPORT_NAME_FORMAT) Omissible<
                Boolean> legacySftpReportNameFormat,
    ...
    public static final class Builder extends ReportRunnerCreateRequest.Builder<Builder> {
        ...
        public ScheduledReportRunnerCreateRequest build() {
            return new ScheduledReportRunnerCreateRequest(name, reportType, formats, parameters, tags, scopes,
