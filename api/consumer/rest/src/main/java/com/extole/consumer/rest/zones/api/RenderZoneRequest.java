...
public class RenderZoneRequest {
    ...
    @JsonCreator
    public RenderZoneRequest(@JsonProperty(EVENT_NAME) String eventName,
        @Nullable @JsonProperty(JWT) String jwt,
        @Nullable @JsonProperty(ID_TOKEN) String idToken,
        @Nullable @JsonProperty(DATA) Map<String, ? extends Object> data) {
    ...
    public static final class Builder {
        ...
        public RenderZoneRequest build() {
            return new RenderZoneRequest(eventName, jwt, idToken, data);
        }
    }
}
