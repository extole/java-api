...
public class FriendReminderEmailResponse implements PollingResponse {

    private final String pollingId;
    private final PollingStatus status;

    public FriendReminderEmailResponse(@JsonProperty(PollingResponse.POLLING_ID) String pollingId,
