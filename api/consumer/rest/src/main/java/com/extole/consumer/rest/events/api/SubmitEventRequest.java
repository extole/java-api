...
public class SubmitEventRequest {
    ...
    @JsonCreator
    public SubmitEventRequest(@JsonProperty(EVENT_NAME) String eventName,
        @Nullable @JsonProperty(JWT) String jwt,
        @Nullable @JsonProperty(ID_TOKEN) String idToken,
        @Nullable @JsonProperty(value = DATA) Map<String, String> data) {
    ...
    public static final class Builder {
        ...
        public SubmitEventRequest build() {
            return new SubmitEventRequest(eventName, jwt, idToken, data);
        }
    }
