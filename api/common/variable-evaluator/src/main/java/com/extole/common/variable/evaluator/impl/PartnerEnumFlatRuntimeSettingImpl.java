...
public class PartnerEnumFlatRuntimeSettingImpl implements PartnerEnumRuntimeFlatSetting {

    private static final SettingType TYPE = SettingType.PARTNER_ENUM;

    private final RuntimeFlatSettingImpl runtimeFlatVariable;
    private final List<PartnerEnumListVariableOption> options;

    public PartnerEnumFlatRuntimeSettingImpl(String name,
        String variant,
    ...
    public boolean equals(Object other) {
        ...
        PartnerEnumFlatRuntimeSettingImpl that = (PartnerEnumFlatRuntimeSettingImpl) other;
