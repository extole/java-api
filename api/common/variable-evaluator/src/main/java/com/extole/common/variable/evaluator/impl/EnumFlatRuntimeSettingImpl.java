...
public class EnumFlatRuntimeSettingImpl
    implements EnumRuntimeFlatSetting {

    private static final SettingType TYPE = SettingType.ENUM;

    private final RuntimeFlatSettingImpl runtimeFlatVariable;
    private final List<EnumVariableMember> enumVariableMembers;

    public EnumFlatRuntimeSettingImpl(
        String name,
        String variant,
    ...
    public boolean equals(Object other) {
        ...
        EnumFlatRuntimeSettingImpl that = (EnumFlatRuntimeSettingImpl) other;
