...
public final class JavascriptBuildtimeEvaluatable<CONTEXT, RESULT>
    ...
    private JavascriptBuildtimeEvaluatable(String expression, JavaType expectedResultType) {
        this.expression = expression;
        this.expectedResultType = expectedResultType;
    }

    public static <CONTEXT, RESULT> JavascriptBuildtimeEvaluatable<CONTEXT, RESULT> of(String expression,
        TypeReference<RESULT> expectedResultTypeReference) {
        return new JavascriptBuildtimeEvaluatable<>(expression,
            OBJECT_MAPPER.constructType(expectedResultTypeReference));
    }

    public static <CONTEXT, RESULT> JavascriptBuildtimeEvaluatable<CONTEXT, RESULT> of(String expression,
        JavaType expectedResultType) {
        return new JavascriptBuildtimeEvaluatable<>(expression, expectedResultType);
    }
