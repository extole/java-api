...
@Component
public class AsyncKafkaProducerConfig implements KafkaProducerConfig, Serializable {
    ...
    @Autowired
    public AsyncKafkaProducerConfig(
        ...
        @Value("${kafka.async.producer.request.timeout.ms:3000}") Integer requestTimeoutMs,
        ...
        @Value("${kafka.async.producer.buffer.memory.bytes:100000000}") Long bufferMemory,
        @Value("${kafka.async.producer.delivery.timeout.ms:60000}") Integer deliveryTimeoutMs) {
