...
@Component
public class DefaultJavascriptLibraryProvider implements JavascriptLibraryProvider {
    private final RemoteJavascriptLibraryProvider javascriptLibraryProvider;

    @Autowired
    public DefaultJavascriptLibraryProvider(
        ...
        this.javascriptLibraryProvider =
            new RemoteJavascriptLibraryProvider(metricRegistry, cacheExpirationMinutes, cacheSize, true,
