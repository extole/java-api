...
public final class CampaignControllerTriggerHasIdentityUpdateRequest extends CampaignControllerTriggerRequest {

    @JsonCreator
    private CampaignControllerTriggerHasIdentityUpdateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerHasIdentityUpdateRequest build() {
            ...
            return new CampaignControllerTriggerHasIdentityUpdateRequest(triggerPhase,
                name,
