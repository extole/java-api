package com.extole.client.rest.campaign.built.controller.action.decline;
...
public class BuiltCampaignControllerActionDeclineResponse extends BuiltCampaignControllerActionResponse {
    ...
    @JsonCreator
    public BuiltCampaignControllerActionDeclineResponse(
        ...
        super(actionId, CampaignControllerActionType.DECLINE, quality, enabled, componentIds, componentReferences);
