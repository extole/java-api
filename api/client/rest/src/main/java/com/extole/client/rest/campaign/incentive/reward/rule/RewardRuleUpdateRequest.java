...
public class RewardRuleUpdateRequest {
    ...
    private static final String DATA_ATTRIBUTE_MATHER_TYPE = "data_attribute_matcher_type";
    ...
    private final Omissible<String> rewardSupplierId;
    ...
    @JsonCreator
    public RewardRuleUpdateRequest(@JsonProperty(REWARDEE) Omissible<Rewardee> rewardee,
        @JsonProperty(REWARD_SUPPLIER_ID) Omissible<String> rewardSupplierId,
        ...
        @JsonProperty(DATA_ATTRIBUTE_MATHER_TYPE) Omissible<RuleDataMatcherType> dataAttributeMatcherType,
    ...
    public Omissible<String> getRewardSupplierId() {
    ...
    @JsonProperty(DATA_ATTRIBUTE_MATHER_TYPE)
    ...
    public static final class Builder {
        ...
        private Omissible<String> rewardSupplierId = Omissible.omitted();
        ...
        private Omissible<Set<String>> rewardSlots = Omissible.omitted();
        ...
        public Builder withRewardSlots(Set<String> rewardSlots) {
            this.rewardSlots = Omissible.of(rewardSlots);
            return this;
        }
        ...
        public Builder withDataAttributeMatcherType(RuleDataMatcherType dataAttributeMatcherType) {
            this.dataAttributeMatcherType = Omissible.of(dataAttributeMatcherType);
            return this;
        }

        public Builder withExpression(RewardRuleExpression rewardRuleExpression) {
            this.rewardRuleExpression = Omissible.of(rewardRuleExpression);
            return this;
        }
        ...
        public RewardRuleUpdateRequest build() {
            return new RewardRuleUpdateRequest(rewardee, rewardSupplierId, referralsPerReward, rewardCountLimit,
                rewardCountSinceMonth, rewardCountSinceDays, rewardValueLimit, rewardValueSinceMonth,
                rewardValueSinceDays, uniqueFriendRequired, referralLoopAllowed, rewardSlots, minCartValue,
