...
public class CampaignLaunchTestRequest {
    ...
    CampaignLaunchTestRequest(@JsonProperty(MESSAGE) Omissible<Optional<String>> message,
    ...
    public static final class Builder {
        ...
        public CampaignLaunchTestRequest build() {
            return new CampaignLaunchTestRequest(message, startDate, stopDate);
        }
    }
}
