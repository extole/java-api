...
public class ManualCouponRewardSupplierV2Response extends BaseRewardSupplierV2Response {
    ...
    public ManualCouponRewardSupplierV2Response(@JsonProperty(REWARD_SUPPLIER_ID) String id,
