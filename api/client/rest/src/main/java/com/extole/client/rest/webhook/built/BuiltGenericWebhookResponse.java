...
public class BuiltGenericWebhookResponse extends BuiltWebhookResponse {

    static final String WEBHOOK_TYPE = "GENERIC";

    @JsonCreator
    public BuiltGenericWebhookResponse(
        ...
        super(id, name, WebhookType.GENERIC, url, clientKeyId, tags, request, responseHandler, enabled, description,
