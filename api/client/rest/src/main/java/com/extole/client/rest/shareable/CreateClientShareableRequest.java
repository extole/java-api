...
public final class CreateClientShareableRequest {
    ...
    private final Omissible<ClientShareableContentRequest> content;
    private final Omissible<Map<String, String>> data;
    private final Omissible<String> programUrl;

    @JsonCreator
    private CreateClientShareableRequest(
        ...
        @JsonProperty(JSON_PROPERTY_CONTENT) Omissible<ClientShareableContentRequest> content,
    ...
    public Omissible<ClientShareableContentRequest> getContent() {
        return content;
    }
    ...
    public static final class Builder {
        ...
        private Omissible<ClientShareableContentRequest> content = Omissible.omitted();
        ...
        public Builder withContent(ClientShareableContentRequest content) {
        ...
        public CreateClientShareableRequest build() {
            return new CreateClientShareableRequest(label, code, key, content, data, programUrl);
        }
    }
}
