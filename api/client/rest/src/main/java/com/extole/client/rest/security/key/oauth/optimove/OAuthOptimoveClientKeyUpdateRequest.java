...
public class OAuthOptimoveClientKeyUpdateRequest extends OAuthClientKeyUpdateRequest {

    public static final String ALGORITHM_NAME_OAUTH_OPTIMOVE = "OAUTH_OPTIMOVE";

    @JsonCreator
    public OAuthOptimoveClientKeyUpdateRequest(
    ...
    public static final class Builder extends OAuthClientKeyUpdateRequest.Builder {
        ...
        @Override
        public OAuthOptimoveClientKeyUpdateRequest build() {
            ...
            return new OAuthOptimoveClientKeyUpdateRequest(ClientKeyAlgorithm.OAUTH_OPTIMOVE, name, description, key,
