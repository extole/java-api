...
public class CampaignComponentEnumListVariableResponse
    extends CampaignComponentVariableResponse {
    public static final String SETTING_TYPE = "ENUM_LIST";
    private static final String JSON_ALLOWED_VALUES = "allowed_values";

    private final List<String> allowedValues;

    @JsonCreator
    public CampaignComponentEnumListVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
