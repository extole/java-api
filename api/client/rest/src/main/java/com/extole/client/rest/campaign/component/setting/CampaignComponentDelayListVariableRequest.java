...
public final class CampaignComponentDelayListVariableRequest extends CampaignComponentVariableRequest {

    static final String SETTING_TYPE = "DELAY_LIST";

    @JsonCreator
    public CampaignComponentDelayListVariableRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        extends CampaignComponentVariableRequest.Builder<CALLER, CampaignComponentDelayListVariableRequest,
        ...
        @Override
        public CampaignComponentDelayListVariableRequest build() {
            return new CampaignComponentDelayListVariableRequest(
                name,
                displayName,
                type,
                values,
