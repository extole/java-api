...
public class CampaignControllerTriggerTargetingCreateRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    public CampaignControllerTriggerTargetingCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        @Override
        public CampaignControllerTriggerTargetingCreateRequest build() {
            ...
            return new CampaignControllerTriggerTargetingCreateRequest(
                triggerPhase,
                name,
