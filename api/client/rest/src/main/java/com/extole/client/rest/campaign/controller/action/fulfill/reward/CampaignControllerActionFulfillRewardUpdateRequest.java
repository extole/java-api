...
public class CampaignControllerActionFulfillRewardUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionFulfillRewardUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public Builder withSuccess(String success) {
            this.success = Omissible.of(Optional.of(success));
            return this;
        }

        public Builder withPartnerRewardId(String partnerRewardId) {
            this.partnerRewardId = Omissible.of(Optional.of(partnerRewardId));
            return this;
        }
        ...
        public CampaignControllerActionFulfillRewardUpdateRequest build() {
            ...
            return new CampaignControllerActionFulfillRewardUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                rewardId,
