...
public class ClientDomainPatternQueryParams {
    ...
    public ClientDomainPatternQueryParams(
    ...
    public static final class Builder {
        ...
        public ClientDomainPatternQueryParams build() {
            return new ClientDomainPatternQueryParams(clientDomainId, includeArchived, limit, offset);
        }
