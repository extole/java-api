...
public class CampaignControllerActionEmailCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    public CampaignControllerActionEmailCreateRequest(
    ...
    public CampaignControllerActionEmailCreateRequest(String zoneName,
        ...
        this(Omissible.omitted(),
            ...
            Omissible.omitted(),
            Omissible.omitted(),
            Omissible.of(Provided.of(zoneName)),
            Omissible.of(data));
    }
    ...
    public static class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionEmailCreateRequest build() {
            ...
            return new CampaignControllerActionEmailCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                zoneName,
