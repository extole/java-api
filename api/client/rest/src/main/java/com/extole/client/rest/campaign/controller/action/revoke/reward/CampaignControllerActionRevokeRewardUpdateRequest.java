...
public class CampaignControllerActionRevokeRewardUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionRevokeRewardUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionRevokeRewardUpdateRequest build() {
            ...
            return new CampaignControllerActionRevokeRewardUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                rewardId,
