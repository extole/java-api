...
public final class CampaignControllerTriggerHasPriorStepUpdateRequest extends CampaignControllerTriggerRequest {
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public Builder clearFilterExpressions() {
            this.filterExpressions = Omissible.of(ImmutableSet.of());
            return this;
        }
        ...
        public Builder clearCountMatches() {
            this.countMatches = Omissible.of(Provided.emptySet());
            return this;
        }
        ...
        public Builder clearPersonId() {
            this.personId = Omissible.of(Provided.optionalEmpty());
            return this;
        }
