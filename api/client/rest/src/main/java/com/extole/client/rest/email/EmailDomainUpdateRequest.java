...
public class EmailDomainUpdateRequest {
    ...
    @JsonProperty(DOMAIN)
    public Omissible<String> getDomain() {
        return domain;
    }
    ...
    public static final class Builder {
        private Omissible<String> domain = Omissible.omitted();
        ...
        public Builder withDomain(String domain) {
            this.domain = Omissible.of(domain);
            return this;
        }
        ...
        public EmailDomainUpdateRequest build() {
            return new EmailDomainUpdateRequest(domain, dkimCnameRecords, forceSendFromEmailDomain);
        }
    }
