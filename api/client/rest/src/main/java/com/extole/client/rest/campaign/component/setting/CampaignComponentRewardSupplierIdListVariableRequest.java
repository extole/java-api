...
public class CampaignComponentRewardSupplierIdListVariableRequest
    ...
    @JsonCreator
    public CampaignComponentRewardSupplierIdListVariableRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        ...
        public BUILDER_TYPE withAllowedRewardSupplierIds(
        ...
        public CampaignComponentRewardSupplierIdListVariableRequest build() {
            return new CampaignComponentRewardSupplierIdListVariableRequest(
                name,
                displayName,
                values,
                source,
