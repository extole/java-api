...
public class BuiltComponentEnumListVariableResponse extends BuiltCampaignComponentVariableResponse {
    ...
    @JsonCreator
    public BuiltComponentEnumListVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
