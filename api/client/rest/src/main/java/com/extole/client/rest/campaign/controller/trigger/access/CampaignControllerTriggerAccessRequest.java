...
public class CampaignControllerTriggerAccessRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    public CampaignControllerTriggerAccessRequest(
        ...
        this.trustedScopes = trustedScopes != null ? ImmutableSet.copyOf(trustedScopes) : null;
    }
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        private Set<Scope> trustedScopes;

        private Builder() {
        }

        public Builder withTrustedScopes(Set<Scope> trustedScopes) {
            this.trustedScopes = trustedScopes;
            return this;
        }

        public CampaignControllerTriggerAccessRequest build() {
            ...
            return new CampaignControllerTriggerAccessRequest(
                triggerPhase,
                name,
