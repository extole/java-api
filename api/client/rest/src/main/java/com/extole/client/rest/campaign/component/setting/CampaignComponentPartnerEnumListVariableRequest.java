...
public final class CampaignComponentPartnerEnumListVariableRequest
    ...
    @JsonCreator
    private CampaignComponentPartnerEnumListVariableRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        extends
        CampaignComponentVariableRequest.Builder<CALLER, CampaignComponentPartnerEnumListVariableRequest,
        ...
        @Override
        public CampaignComponentPartnerEnumListVariableRequest build() {
            return new CampaignComponentPartnerEnumListVariableRequest(
                name,
                displayName,
                type,
                values,
