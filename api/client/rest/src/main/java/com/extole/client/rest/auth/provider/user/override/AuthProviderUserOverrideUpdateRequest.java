...
public class AuthProviderUserOverrideUpdateRequest {
    ...
    public AuthProviderUserOverrideUpdateRequest(@Nullable @JsonProperty(NAME) String name,
    ...
    public static final class Builder {
        ...
        public Builder withAuthProviderEnabled(Boolean authProviderEnabledForUser) {
            this.authProviderEnabledForUser = authProviderEnabledForUser;
            return this;
        }
        ...
        public AuthProviderUserOverrideUpdateRequest build() {
            return new AuthProviderUserOverrideUpdateRequest(name,
