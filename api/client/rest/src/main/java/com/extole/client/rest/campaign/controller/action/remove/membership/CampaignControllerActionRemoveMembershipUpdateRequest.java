...
public final class CampaignControllerActionRemoveMembershipUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionRemoveMembershipUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionRemoveMembershipUpdateRequest build() {
            ...
            return new CampaignControllerActionRemoveMembershipUpdateRequest(quality,
                enabled,
                audienceId,
                componentIds,
                componentReferences);
