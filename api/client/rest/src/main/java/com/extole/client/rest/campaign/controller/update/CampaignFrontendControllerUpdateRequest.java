...
public class CampaignFrontendControllerUpdateRequest extends CampaignStepUpdateRequest {
    ...
    public CampaignFrontendControllerUpdateRequest(
    ...
    public static final class Builder
        extends CampaignStepUpdateRequest.Builder<Builder, CampaignFrontendControllerUpdateRequest> {
        ...
        @Override
        public CampaignFrontendControllerUpdateRequest build() {
            ...
            return new CampaignFrontendControllerUpdateRequest(
                enabled,
                componentIds,
                componentReferences,
                name,
