...
public final class CampaignComponentFacetRequest {
    ...
    @JsonCreator
    public CampaignComponentFacetRequest(
    ...
    public static final class Builder<CALLER> {
        ...
        public CampaignComponentFacetRequest build() {
            return new CampaignComponentFacetRequest(name, value);
        }
