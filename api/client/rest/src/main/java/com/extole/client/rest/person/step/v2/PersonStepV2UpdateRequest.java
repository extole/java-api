...
public class PersonStepV2UpdateRequest {
    ...
    @JsonCreator
    public PersonStepV2UpdateRequest(
    ...
    public static final class Builder {
        ...
        public PersonStepV2UpdateRequest build() {
            return new PersonStepV2UpdateRequest(container);
        }
