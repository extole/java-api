...
public class StepDataConfiguration {
    ...
    private final Omissible<Id<StepDataConfiguration>> id;
    ...
    public StepDataConfiguration(
        @JsonProperty(JSON_ID) Omissible<Id<StepDataConfiguration>> id,
        ...
        this.componentReferences =
            componentReferences != null ? ImmutableList.copyOf(componentReferences) : Collections.emptyList();
    }

    @JsonProperty(JSON_ID)
    public Omissible<Id<StepDataConfiguration>> getId() {
        return id;
    }
