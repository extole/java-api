...
public class ManualCouponRewardSupplierCreateRequest extends RewardSupplierCreateRequest {
    ...
    public ManualCouponRewardSupplierCreateRequest(
    ...
    public static final class Builder
        extends RewardSupplierCreateRequest.Builder<ManualCouponRewardSupplierCreateRequest, Builder> {
        private Integer couponCountWarnLimit;
        ...
        public ManualCouponRewardSupplierCreateRequest build() {
            ...
            return new ManualCouponRewardSupplierCreateRequest(
                faceValueType,
