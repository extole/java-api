...
public class CampaignComponentEnumListVariableConfiguration extends CampaignComponentVariableConfiguration {

    public static final String SETTING_TYPE_ENUM_LIST = "ENUM_LIST";
    ...
    @JsonCreator
    public CampaignComponentEnumListVariableConfiguration(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
