...
public class CampaignControllerActionCreateMembershipConfiguration extends CampaignControllerActionConfiguration {
    ...
    public CampaignControllerActionCreateMembershipConfiguration(
        ...
        super(actionId, CampaignControllerActionType.CREATE_MEMBERSHIP, quality, enabled, componentReferences);
