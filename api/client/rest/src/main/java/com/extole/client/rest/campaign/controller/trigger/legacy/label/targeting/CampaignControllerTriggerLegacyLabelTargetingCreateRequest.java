...
public final class CampaignControllerTriggerLegacyLabelTargetingCreateRequest extends CampaignControllerTriggerRequest {

    @JsonCreator
    private CampaignControllerTriggerLegacyLabelTargetingCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerLegacyLabelTargetingCreateRequest build() {
            ...
            return new CampaignControllerTriggerLegacyLabelTargetingCreateRequest(triggerPhase,
                name,
