...
public class RewardRuleConfiguration {
    ...
    private final Omissible<Id<RewardRuleConfiguration>> id;
    ...
    public RewardRuleConfiguration(@JsonProperty(REWARD_RULE_ID) Omissible<Id<RewardRuleConfiguration>> id,
        ...
        this.rewardSlots = rewardSlots != null ? rewardSlots : Collections.emptySet();
    ...
    public Omissible<Id<RewardRuleConfiguration>> getId() {
        return id;
    }
