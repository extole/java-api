...
public class CampaignControllerActionCancelRewardConfiguration extends CampaignControllerActionConfiguration {
    ...
    public CampaignControllerActionCancelRewardConfiguration(
        ...
        super(actionId, CampaignControllerActionType.CANCEL_REWARD, quality, enabled, componentReferences);
