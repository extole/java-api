...
public class OAuthLeadPerfectionClientKeyUpdateRequest extends OAuthClientKeyUpdateRequest {

    public static final String ALGORITHM_NAME_OAUTH_LEAD_PERFECTION = "OAUTH_LEAD_PERFECTION";

    @JsonCreator
    public OAuthLeadPerfectionClientKeyUpdateRequest(
    ...
    public static final class Builder extends OAuthClientKeyUpdateRequest.Builder {
        ...
        @Override
        public OAuthLeadPerfectionClientKeyUpdateRequest build() {
            ...
            return new OAuthLeadPerfectionClientKeyUpdateRequest(ClientKeyAlgorithm.OAUTH_LEAD_PERFECTION, name,
