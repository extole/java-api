package com.extole.client.rest.webhook.reward.filter.supplier.built;
...
public class BuiltSupplierRewardWebhookFilterResponse {
    ...
    public BuiltSupplierRewardWebhookFilterResponse(@JsonProperty(WEBHOOK_FILTER_ID) String id,
