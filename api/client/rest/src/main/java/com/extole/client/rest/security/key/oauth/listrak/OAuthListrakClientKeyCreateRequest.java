...
public class OAuthListrakClientKeyCreateRequest extends OAuthClientKeyCreateRequest {

    public static final String ALGORITHM_NAME_OAUTH_LISTRAK = "OAUTH_LISTRAK";

    @JsonCreator
    public OAuthListrakClientKeyCreateRequest(
    ...
    public static class Builder extends OAuthClientKeyCreateRequest.Builder {
        ...
        @Override
        public OAuthListrakClientKeyCreateRequest build() {
            ...
            return new OAuthListrakClientKeyCreateRequest(type, ClientKeyAlgorithm.OAUTH_LISTRAK, key, name,
