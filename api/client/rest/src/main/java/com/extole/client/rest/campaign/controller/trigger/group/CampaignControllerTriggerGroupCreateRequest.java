...
public final class CampaignControllerTriggerGroupCreateRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    private CampaignControllerTriggerGroupCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public Builder
            withOperator(BuildtimeEvaluatable<ControllerBuildtimeContext, Operator> operator) {
            this.operator = Omissible.of(operator);
            return this;
        }

        public CampaignControllerTriggerGroupCreateRequest build() {
            ...
            return new CampaignControllerTriggerGroupCreateRequest(triggerPhase,
                name,
