...
public class CampaignControllerActionIncentivizeStatusUpdateCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    public CampaignControllerActionIncentivizeStatusUpdateCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        @Override
        public CampaignControllerActionIncentivizeStatusUpdateCreateRequest build() {
            ...
            return new CampaignControllerActionIncentivizeStatusUpdateCreateRequest(
                quality,
                enabled,
                componentIds,
                componentReferences,
