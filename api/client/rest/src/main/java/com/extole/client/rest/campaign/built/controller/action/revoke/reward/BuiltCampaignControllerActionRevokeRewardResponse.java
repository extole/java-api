package com.extole.client.rest.campaign.built.controller.action.revoke.reward;

import static com.extole.client.rest.campaign.controller.action.CampaignControllerActionType.REVOKE_REWARD;
...
public class BuiltCampaignControllerActionRevokeRewardResponse extends BuiltCampaignControllerActionResponse {
    ...
    public BuiltCampaignControllerActionRevokeRewardResponse(
        ...
        super(actionId, REVOKE_REWARD, quality, enabled, componentIds, componentReferences);
