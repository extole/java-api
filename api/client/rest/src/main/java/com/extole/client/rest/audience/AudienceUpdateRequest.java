...
@Schema
public class AudienceUpdateRequest extends ComponentElementRequest {

    private static final String NAME = "name";
    private static final String ENABLED = "enabled";
    private static final String TAGS = "tags";

    private final Omissible<BuildtimeEvaluatable<AudienceBuildtimeContext, String>> name;
    ...
    public AudienceUpdateRequest(
        @JsonProperty(NAME) Omissible<BuildtimeEvaluatable<AudienceBuildtimeContext, String>> name,
    ...
    @JsonProperty(NAME)
    public Omissible<BuildtimeEvaluatable<AudienceBuildtimeContext, String>> getName() {
        return name;
    }
    ...
    public static AudienceUpdateRequest.Builder builder() {
        return new AudienceUpdateRequest.Builder();
    }

    public static final class Builder extends ComponentElementRequest.Builder<Builder> {

        private Omissible<BuildtimeEvaluatable<AudienceBuildtimeContext, String>> name = Omissible.omitted();
        ...
        public AudienceUpdateRequest build() {
            ...
            return new AudienceUpdateRequest(name, enabled, tags, componentIds, componentReferences);
        }
