...
public final class UpdateClientShareableRequest {
    ...
    @JsonCreator
    private UpdateClientShareableRequest(
    ...
    public static final class Builder {
        ...
        public UpdateClientShareableRequest build() {
            return new UpdateClientShareableRequest(label, key, content, data, programUrl);
        }
    }
}
