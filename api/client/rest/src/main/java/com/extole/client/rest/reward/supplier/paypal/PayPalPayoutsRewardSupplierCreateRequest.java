...
public class PayPalPayoutsRewardSupplierCreateRequest extends RewardSupplierCreateRequest {
    ...
    public static final class Builder
        extends RewardSupplierCreateRequest.Builder<PayPalPayoutsRewardSupplierCreateRequest, Builder> {
        ...
        public PayPalPayoutsRewardSupplierCreateRequest build() {
