...
public class CampaignControllerTriggerTargetingConfiguration extends CampaignControllerTriggerConfiguration {

    private static final String SCOPE = "scope";

    private final BuildtimeEvaluatable<ControllerBuildtimeContext, TargetingScope> scope;

    public CampaignControllerTriggerTargetingConfiguration(
