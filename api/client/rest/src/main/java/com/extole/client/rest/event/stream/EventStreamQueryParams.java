...
public class EventStreamQueryParams {
    ...
    public static final class Builder {
        ...
        public EventStreamQueryParams build() {
            return new EventStreamQueryParams(includeArchived, limit, offset);
        }
