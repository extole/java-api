...
public class ClientTangoSettingsAccountCreationRequest {
    ...
    @JsonCreator
    public ClientTangoSettingsAccountCreationRequest(@Nullable @JsonProperty(JSON_PROPERTY_ENABLED) Boolean enabled,
