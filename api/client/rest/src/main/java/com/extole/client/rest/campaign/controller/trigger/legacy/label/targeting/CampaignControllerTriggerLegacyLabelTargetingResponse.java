...
public class CampaignControllerTriggerLegacyLabelTargetingResponse extends CampaignControllerTriggerResponse {

    public CampaignControllerTriggerLegacyLabelTargetingResponse(
        ...
        super(triggerId, CampaignControllerTriggerType.LEGACY_LABEL_TARGETING, triggerPhase, name, description, enabled,
