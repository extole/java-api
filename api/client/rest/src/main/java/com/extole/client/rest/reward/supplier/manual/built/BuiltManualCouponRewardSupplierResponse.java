package com.extole.client.rest.reward.supplier.manual.built;
...
public class BuiltManualCouponRewardSupplierResponse extends BuiltRewardSupplierResponse {
    ...
    public BuiltManualCouponRewardSupplierResponse(@JsonProperty(REWARD_SUPPLIER_ID) String id,
