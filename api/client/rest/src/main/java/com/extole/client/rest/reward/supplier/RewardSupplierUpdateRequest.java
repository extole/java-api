...
import static com.extole.client.rest.reward.supplier.RewardSupplierUpdateRequest.REWARD_SUPPLIER_TYPE;
...
@JsonSubTypes({
    @JsonSubTypes.Type(value = CustomRewardSupplierUpdateRequest.class,
        name = CustomRewardSupplierUpdateRequest.CUSTOM_REWARD_SUPPLIER_TYPE),
    @JsonSubTypes.Type(value = ManualCouponRewardSupplierUpdateRequest.class,
        name = ManualCouponRewardSupplierUpdateRequest.MANUAL_REWARD_SUPPLIER_TYPE),
    @JsonSubTypes.Type(value = PayPalPayoutsRewardSupplierUpdateRequest.class,
        name = PayPalPayoutsRewardSupplierUpdateRequest.PAYPAL_REWARD_SUPPLIER_TYPE),
    @JsonSubTypes.Type(value = SalesforceCouponRewardSupplierUpdateRequest.class,
        name = SalesforceCouponRewardSupplierUpdateRequest.SALESFORCE_REWARD_SUPPLIER_TYPE),
    @JsonSubTypes.Type(value = TangoRewardSupplierUpdateRequest.class,
        name = TangoRewardSupplierUpdateRequest.TANGO_REWARD_SUPPLIER_TYPE)
})
@Schema(discriminatorProperty = REWARD_SUPPLIER_TYPE, discriminatorMapping = {
    @DiscriminatorMapping(value = CustomRewardSupplierUpdateRequest.CUSTOM_REWARD_SUPPLIER_TYPE,
        schema = CustomRewardSupplierUpdateRequest.class),
    @DiscriminatorMapping(value = ManualCouponRewardSupplierUpdateRequest.MANUAL_REWARD_SUPPLIER_TYPE,
        schema = ManualCouponRewardSupplierUpdateRequest.class),
    @DiscriminatorMapping(value = PayPalPayoutsRewardSupplierUpdateRequest.PAYPAL_REWARD_SUPPLIER_TYPE,
        schema = PayPalPayoutsRewardSupplierUpdateRequest.class),
    @DiscriminatorMapping(value = SalesforceCouponRewardSupplierUpdateRequest.SALESFORCE_REWARD_SUPPLIER_TYPE,
        schema = SalesforceCouponRewardSupplierUpdateRequest.class),
    @DiscriminatorMapping(value = TangoRewardSupplierUpdateRequest.TANGO_REWARD_SUPPLIER_TYPE,
        schema = TangoRewardSupplierUpdateRequest.class)
})
public abstract class RewardSupplierUpdateRequest extends ComponentElementRequest {
    ...
    public RewardSupplierUpdateRequest(
        ...
        Omissible<BuildtimeEvaluatable<RewardSupplierBuildtimeContext, FaceValueType>> faceValueType,
    ...
    public abstract static class Builder<REQUEST extends RewardSupplierUpdateRequest,
        BUILDER extends RewardSupplierUpdateRequest.Builder<REQUEST, BUILDER>>
        ...
        protected Omissible<BuildtimeEvaluatable<RewardSupplierBuildtimeContext,
        ...
        protected Omissible<BuildtimeEvaluatable<RewardSupplierBuildtimeContext, BigDecimal>> maxCashBack =
            Omissible.omitted();
        protected Omissible<BuildtimeEvaluatable<RewardSupplierBuildtimeContext, FaceValueType>> faceValueType =
            Omissible.omitted();
