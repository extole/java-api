...
public final class CampaignControllerTriggerGroupUpdateRequest extends CampaignControllerTriggerRequest {

    private static final String OPERATOR = "operator";

    private final Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, Operator>> operator;

    @JsonCreator
    private CampaignControllerTriggerGroupUpdateRequest(
        ...
        @JsonProperty(OPERATOR) Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, Operator>> operator,
    ...
    public Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, Operator>> getOperator() {
        return operator;
    }
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        private Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, Operator>> operator = Omissible.omitted();

        private Builder() {
        }

        public Builder withOperator(BuildtimeEvaluatable<ControllerBuildtimeContext, Operator> operator) {
            this.operator = Omissible.of(operator);
            return this;
        }

        public CampaignControllerTriggerGroupUpdateRequest build() {
            ...
            return new CampaignControllerTriggerGroupUpdateRequest(triggerPhase,
                name,
