...
public class CampaignControllerTriggerLegacyLabelTargetingConfiguration extends CampaignControllerTriggerConfiguration {

    public CampaignControllerTriggerLegacyLabelTargetingConfiguration(
