...
public final class CampaignControllerActionCreateMembershipCreateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionCreateMembershipCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionCreateMembershipCreateRequest build() {
            ...
            return new CampaignControllerActionCreateMembershipCreateRequest(quality,
                enabled,
                audienceId,
                componentIds,
                componentReferences);
