...
public class CampaignControllerTriggerTargetingResponse extends CampaignControllerTriggerResponse {

    private static final String SCOPE = "scope";

    private final BuildtimeEvaluatable<ControllerBuildtimeContext, TargetingScope> scope;

    public CampaignControllerTriggerTargetingResponse(
        ...
        @JsonProperty(SCOPE) BuildtimeEvaluatable<ControllerBuildtimeContext, TargetingScope> scope,
        @JsonProperty(JSON_COMPONENT_IDS) List<Id<ComponentResponse>> componentIds,
        @JsonProperty(JSON_COMPONENT_REFERENCES) List<ComponentReferenceResponse> componentReferences) {
        super(triggerId, CampaignControllerTriggerType.TARGETING, triggerPhase, name, parentTriggerGroupName,
            description, enabled, negated, componentIds, componentReferences);
        this.scope = scope;
    }

    @JsonProperty(SCOPE)
    public BuildtimeEvaluatable<ControllerBuildtimeContext, TargetingScope> getScope() {
        return scope;
    }
