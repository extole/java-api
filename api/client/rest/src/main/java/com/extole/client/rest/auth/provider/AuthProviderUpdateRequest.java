...
public class AuthProviderUpdateRequest {
    ...
    public AuthProviderUpdateRequest(@Nullable @JsonProperty(NAME) String name,
        @Nullable @JsonProperty(AUTH_PROVIDER_TYPE_ID) String authProviderTypeId,
    ...
    public static final class Builder {
        ...
        public AuthProviderUpdateRequest build() {
            return new AuthProviderUpdateRequest(name,
                authProviderTypeId,
