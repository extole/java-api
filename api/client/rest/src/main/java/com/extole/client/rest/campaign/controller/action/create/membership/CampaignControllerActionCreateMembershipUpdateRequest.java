...
public final class CampaignControllerActionCreateMembershipUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionCreateMembershipUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionCreateMembershipUpdateRequest build() {
            ...
            return new CampaignControllerActionCreateMembershipUpdateRequest(quality,
                enabled,
                audienceId,
                componentIds,
                componentReferences);
