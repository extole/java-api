...
public final class CampaignControllerActionDisplayCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    private CampaignControllerActionDisplayCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionDisplayCreateRequest build() {
            ...
            return new CampaignControllerActionDisplayCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                body,
