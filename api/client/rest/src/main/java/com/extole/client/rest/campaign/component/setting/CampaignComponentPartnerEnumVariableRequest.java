...
public final class CampaignComponentPartnerEnumVariableRequest
    extends CampaignComponentVariableRequest {
    ...
    @JsonCreator
    private CampaignComponentPartnerEnumVariableRequest(
        ...
        super(name, displayName, SettingType.PARTNER_ENUM, values, source, description, tags, priority);
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        extends
        CampaignComponentVariableRequest.Builder<CALLER, CampaignComponentPartnerEnumVariableRequest,
        ...
        @Override
        public CampaignComponentPartnerEnumVariableRequest build() {
            return new CampaignComponentPartnerEnumVariableRequest(
                name,
                displayName,
                type,
                values,
