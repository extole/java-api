...
public class CampaignControllerActionIncentivizeCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    public CampaignControllerActionIncentivizeCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionIncentivizeCreateRequest build() {
            ...
            return new CampaignControllerActionIncentivizeCreateRequest(
                quality,
                enabled,
                componentIds,
                componentReferences,
