...
public final class PersonShareableContentRequest {
    ...
    @JsonCreator
    private PersonShareableContentRequest(
    ...
    public static final class Builder {
        ...
        public PersonShareableContentRequest build() {
            return new PersonShareableContentRequest(partnerContentId, title, imageUrl, description, url);
        }
    }
}
