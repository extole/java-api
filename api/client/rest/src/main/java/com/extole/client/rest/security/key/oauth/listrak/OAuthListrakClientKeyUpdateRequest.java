package com.extole.client.rest.security.key.oauth.listrak;
...
public class OAuthListrakClientKeyUpdateRequest extends OAuthClientKeyUpdateRequest {

    public static final String ALGORITHM_NAME_OAUTH_LISTRAK = "OAUTH_LISTRAK";

    @JsonCreator
    public OAuthListrakClientKeyUpdateRequest(
    ...
    public static final class Builder extends OAuthClientKeyUpdateRequest.Builder {
        ...
        @Override
        public OAuthListrakClientKeyUpdateRequest build() {
            ...
            return new OAuthListrakClientKeyUpdateRequest(ClientKeyAlgorithm.OAUTH_LISTRAK, name, description, key,
                oAuthClientId, authorizationUrl, scope, componentIds,
                componentReferences, partnerKeyId);
        }
