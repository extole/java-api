...
public class CampaignControllerTriggerReferredByEventCreateRequest extends ComponentElementRequest {
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerReferredByEventCreateRequest build() {
            ...
            return new CampaignControllerTriggerReferredByEventCreateRequest(triggerPhase, name, description, enabled,
                negated, referralOriginator, componentIds,
                componentReferences);
        }
    }
}
