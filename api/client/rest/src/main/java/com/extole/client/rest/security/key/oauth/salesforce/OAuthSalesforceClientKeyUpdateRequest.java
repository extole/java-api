...
public class OAuthSalesforceClientKeyUpdateRequest extends OAuthClientKeyUpdateRequest {

    public static final String ALGORITHM_NAME_OAUTH_SALESFORCE = "OAUTH_SALESFORCE";

    @JsonCreator
    public OAuthSalesforceClientKeyUpdateRequest(
    ...
    public static final class Builder extends OAuthClientKeyUpdateRequest.Builder {
        ...
        @Override
        public OAuthSalesforceClientKeyUpdateRequest build() {
            ...
            return new OAuthSalesforceClientKeyUpdateRequest(ClientKeyAlgorithm.OAUTH_SALESFORCE, name, description,
                key, oAuthClientId, authorizationUrl, scope, componentIds,
                componentReferences, partnerKeyId);
        }
