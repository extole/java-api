...
public class CampaignControllerActionApproveConfiguration extends CampaignControllerActionConfiguration {
    ...
    @JsonCreator
    public CampaignControllerActionApproveConfiguration(
        ...
        @JsonProperty(JSON_REWARD_TAGS) BuildtimeEvaluatable<ControllerBuildtimeContext,
            RuntimeEvaluatable<ApproveActionContext, Set<String>>> rewardTags) {
        super(actionId, CampaignControllerActionType.APPROVE, quality, enabled, componentReferences);
