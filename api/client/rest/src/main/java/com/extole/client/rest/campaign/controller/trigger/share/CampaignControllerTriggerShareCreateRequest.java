...
public class CampaignControllerTriggerShareCreateRequest extends CampaignControllerTriggerRequest {
    ...
    public CampaignControllerTriggerShareCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        private Set<CampaignControllerTriggerShareChannel> shareTypes;
        ...
        @Deprecated // TODO remove share_types ENG-10463
        public Builder withShareTypes(Set<CampaignControllerTriggerShareChannel> shareTypes) {
        ...
        public CampaignControllerTriggerShareCreateRequest build() {
            ...
            return new CampaignControllerTriggerShareCreateRequest(triggerPhase,
                name,
