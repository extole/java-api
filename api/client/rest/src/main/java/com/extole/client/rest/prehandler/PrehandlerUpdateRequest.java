...
public class PrehandlerUpdateRequest extends ComponentElementRequest {
    ...
    private final Omissible<BuildtimeEvaluatable<PrehandlerBuildtimeContext, String>> name;
    ...
    @JsonCreator
    public PrehandlerUpdateRequest(
        @JsonProperty(JSON_NAME) Omissible<BuildtimeEvaluatable<PrehandlerBuildtimeContext, String>> name,
    ...
    @Schema(nullable = true, description = "Prehandler name must be unique.")
    public Omissible<BuildtimeEvaluatable<PrehandlerBuildtimeContext, String>> getName() {
        return name;
    }
    ...
    public static class Builder extends ComponentElementRequest.Builder<Builder> {
        private Omissible<BuildtimeEvaluatable<PrehandlerBuildtimeContext, String>> name = Omissible.omitted();
        ...
        public PrehandlerUpdateRequest build() {
            ...
            return new PrehandlerUpdateRequest(name, description, enabled, order, tags, conditions, actions,
