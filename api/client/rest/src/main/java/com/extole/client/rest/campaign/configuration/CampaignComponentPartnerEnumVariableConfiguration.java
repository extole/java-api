...
public class CampaignComponentPartnerEnumVariableConfiguration extends CampaignComponentVariableConfiguration {

    public static final String SETTING_TYPE_PARTNER = "PARTNER_ENUM";
    ...
    @JsonCreator
    public CampaignComponentPartnerEnumVariableConfiguration(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
