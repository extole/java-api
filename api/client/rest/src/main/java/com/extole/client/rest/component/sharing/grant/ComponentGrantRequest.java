...
public class ComponentGrantRequest {
    ...
    @JsonCreator
    public ComponentGrantRequest(
        @JsonProperty(CLIENT_ID) String clientId,
        @JsonProperty(SUBSCRIPTION_MODE) Omissible<SubscriptionMode> subscriptionMode) {
    ...
    public static final class Builder {
        ...
        public ComponentGrantRequest build() {
            return new ComponentGrantRequest(clientId, subscriptionMode);
        }
    }
