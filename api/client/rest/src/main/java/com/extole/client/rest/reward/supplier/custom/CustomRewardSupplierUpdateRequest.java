...
public class CustomRewardSupplierUpdateRequest extends RewardSupplierUpdateRequest {
    ...
    public static final class Builder
        extends RewardSupplierUpdateRequest.Builder<CustomRewardSupplierUpdateRequest, Builder> {
        ...
        public Builder withAutoFulfillmentEnabled(Boolean autoFulfillmentEnabled) {
        ...
        public CustomRewardSupplierUpdateRequest build() {
