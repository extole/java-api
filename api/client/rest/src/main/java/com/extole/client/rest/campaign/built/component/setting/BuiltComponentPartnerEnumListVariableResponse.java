...
public class BuiltComponentPartnerEnumListVariableResponse extends BuiltCampaignComponentVariableResponse {
    ...
    @JsonCreator
    public BuiltComponentPartnerEnumListVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
