...
public class BuiltCampaignControllerTriggerGroupResponse extends BuiltCampaignControllerTriggerResponse {

    private static final String OPERATOR = "operator";

    private final Operator operator;

    public BuiltCampaignControllerTriggerGroupResponse(
