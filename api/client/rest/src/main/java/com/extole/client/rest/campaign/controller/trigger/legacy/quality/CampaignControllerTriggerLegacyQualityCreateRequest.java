...
public class CampaignControllerTriggerLegacyQualityCreateRequest extends ComponentElementRequest {
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerLegacyQualityCreateRequest build() {
            ...
            return new CampaignControllerTriggerLegacyQualityCreateRequest(triggerPhase, name, description, enabled,
                negated, actionType, componentIds,
                componentReferences);
        }
