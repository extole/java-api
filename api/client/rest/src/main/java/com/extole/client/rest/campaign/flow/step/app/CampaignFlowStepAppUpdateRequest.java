...
public final class CampaignFlowStepAppUpdateRequest extends ComponentElementRequest {
    ...
    private final Omissible<CampaignFlowStepAppTypeCreateRequest> type;

    @JsonCreator
    public CampaignFlowStepAppUpdateRequest(
        ...
        @JsonProperty(JSON_TYPE) Omissible<CampaignFlowStepAppTypeCreateRequest> type,
    ...
    public Omissible<CampaignFlowStepAppTypeCreateRequest> getType() {
        return type;
    }
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignFlowStepAppUpdateRequest build() {
            Omissible<CampaignFlowStepAppTypeCreateRequest> type = Omissible.omitted();
            if (typeBuilder != null) {
                type = Omissible.of(typeBuilder.build());
            }
            ...
            return new CampaignFlowStepAppUpdateRequest(name,
                description,
                type,
                componentIds,
                componentReferences);
