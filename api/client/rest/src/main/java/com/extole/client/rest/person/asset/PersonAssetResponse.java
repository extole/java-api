...
public class PersonAssetResponse {
    ...
    private final PersonAssetType dataType;
    ...
    public PersonAssetResponse(
        ...
        @JsonProperty(DATA_TYPE) PersonAssetType dataType) {
        this.id = id;
        this.name = name;
    ...
    public PersonAssetType getDataType() {
        return dataType;
    }
    ...
    public static final class Builder {
        ...
        private PersonAssetType dataType;
        ...
        public Builder withDataType(PersonAssetType dataType) {
            this.dataType = dataType;
            return this;
        }
