...
public class SalesforceCouponRewardSupplierUpdateV2Request extends ComponentElementRequest {
    ...
    public SalesforceCouponRewardSupplierUpdateV2Request(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public SalesforceCouponRewardSupplierUpdateV2Request build() {
            ...
            return new SalesforceCouponRewardSupplierUpdateV2Request(faceValueType,
