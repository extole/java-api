...
public class CampaignControllerTriggerHasPriorRewardUpdateRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    public CampaignControllerTriggerHasPriorRewardUpdateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public Builder
            withTaxYearStart(BuildtimeEvaluatable<ControllerBuildtimeContext, Optional<MonthDay>> taxYearStart) {
            this.taxYearStart = Omissible.of(taxYearStart);
            return this;
        }

        public CampaignControllerTriggerHasPriorRewardUpdateRequest build() {
            ...
            return new CampaignControllerTriggerHasPriorRewardUpdateRequest(triggerPhase,
                name,
