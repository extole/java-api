...
public class CampaignControllerActionIncentivizeConfiguration extends CampaignControllerActionConfiguration {
    ...
    public CampaignControllerActionIncentivizeConfiguration(
        ...
        super(actionId, CampaignControllerActionType.INCENTIVIZE, quality, enabled, componentReferences);
