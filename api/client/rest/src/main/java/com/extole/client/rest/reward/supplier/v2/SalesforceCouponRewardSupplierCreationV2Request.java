...
public class SalesforceCouponRewardSupplierCreationV2Request extends ComponentElementRequest {
    ...
    public SalesforceCouponRewardSupplierCreationV2Request(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public SalesforceCouponRewardSupplierCreationV2Request build() {
            ...
            return new SalesforceCouponRewardSupplierCreationV2Request(faceValueType,
