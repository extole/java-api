...
public final class BatchComponentVariableUpdateResponse {
    ...
    @JsonCreator
    public BatchComponentVariableUpdateResponse(
    ...
    public static final class Builder {
        private String componentAbsolutePath;
        private String name;
        ...
        private Builder(BatchComponentVariableUpdateResponse batchComponentVariableUpdateResponse) {
            ...
            this.name = batchComponentVariableUpdateResponse.name;
            this.displayName = batchComponentVariableUpdateResponse.displayName;
            this.settingType = batchComponentVariableUpdateResponse.settingType;
            this.values = batchComponentVariableUpdateResponse.values;
        }
        ...
        public BatchComponentVariableUpdateResponse build() {
            return new BatchComponentVariableUpdateResponse(
                this.componentAbsolutePath,
                this.name,
                this.displayName,
                this.settingType,
                this.values);
