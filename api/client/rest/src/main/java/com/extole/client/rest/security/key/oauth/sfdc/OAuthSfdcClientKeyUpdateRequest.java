...
public class OAuthSfdcClientKeyUpdateRequest extends OAuthClientKeyUpdateRequest {

    public static final String ALGORITHM_NAME_OAUTH_SFDC = "OAUTH_SFDC";

    @JsonCreator
    public OAuthSfdcClientKeyUpdateRequest(
    ...
    public static final class Builder extends OAuthClientKeyUpdateRequest.Builder {
        ...
        @Override
        public OAuthSfdcClientKeyUpdateRequest build() {
            ...
            return new OAuthSfdcClientKeyUpdateRequest(ClientKeyAlgorithm.OAUTH_SFDC, name, description, key,
