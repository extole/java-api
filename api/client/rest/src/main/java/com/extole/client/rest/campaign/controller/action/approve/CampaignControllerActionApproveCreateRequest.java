...
public final class CampaignControllerActionApproveCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    private CampaignControllerActionApproveCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionApproveCreateRequest build() {
            ...
            return new CampaignControllerActionApproveCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                legacyActionId,
