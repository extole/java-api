...
public class ManualCouponRewardSupplierUpdateV2Request extends ComponentElementRequest {
    ...
    public ManualCouponRewardSupplierUpdateV2Request(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        private Omissible<BuildtimeEvaluatable<RewardSupplierBuildtimeContext, Optional<Integer>>> limitPerHour =
            Omissible.omitted();
        private Omissible<Map<String, BuildtimeEvaluatable<RewardSupplierBuildtimeContext, String>>> data = Omissible
            .omitted();
        ...
        public ManualCouponRewardSupplierUpdateV2Request build() {
            ...
            return new ManualCouponRewardSupplierUpdateV2Request(faceValueType,
