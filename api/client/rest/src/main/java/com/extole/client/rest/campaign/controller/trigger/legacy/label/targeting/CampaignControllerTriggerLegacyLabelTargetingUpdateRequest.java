...
public final class CampaignControllerTriggerLegacyLabelTargetingUpdateRequest extends CampaignControllerTriggerRequest {

    @JsonCreator
    private CampaignControllerTriggerLegacyLabelTargetingUpdateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerLegacyLabelTargetingUpdateRequest build() {
            ...
            return new CampaignControllerTriggerLegacyLabelTargetingUpdateRequest(triggerPhase,
                name,
