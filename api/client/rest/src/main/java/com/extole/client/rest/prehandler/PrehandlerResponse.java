...
public class PrehandlerResponse extends ComponentElementResponse {
    ...
    private final BuildtimeEvaluatable<PrehandlerBuildtimeContext, Optional<String>> description;
    private final BuildtimeEvaluatable<PrehandlerBuildtimeContext, Boolean> enabled;
    private final BuildtimeEvaluatable<PrehandlerBuildtimeContext, Integer> order;
    ...
    @JsonCreator
    public PrehandlerResponse(
        @JsonProperty(JSON_ID) String id,
        @JsonProperty(JSON_NAME) BuildtimeEvaluatable<PrehandlerBuildtimeContext, String> name,
        @JsonProperty(JSON_DESCRIPTION) BuildtimeEvaluatable<PrehandlerBuildtimeContext, Optional<String>> description,
        @JsonProperty(JSON_ENABLED) BuildtimeEvaluatable<PrehandlerBuildtimeContext, Boolean> enabled,
        @JsonProperty(JSON_ORDER) BuildtimeEvaluatable<PrehandlerBuildtimeContext, Integer> order,
    ...
    public BuildtimeEvaluatable<PrehandlerBuildtimeContext, Optional<String>> getDescription() {
        return description;
    }

    @JsonProperty(JSON_ENABLED)
    public BuildtimeEvaluatable<PrehandlerBuildtimeContext, Boolean> isEnabled() {
        return enabled;
    }

    @JsonProperty(JSON_ORDER)
    public BuildtimeEvaluatable<PrehandlerBuildtimeContext, Integer> getOrder() {
        return order;
    }
