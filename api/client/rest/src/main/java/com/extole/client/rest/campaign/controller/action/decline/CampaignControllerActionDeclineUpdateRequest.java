...
public final class CampaignControllerActionDeclineUpdateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    private CampaignControllerActionDeclineUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionDeclineUpdateRequest build() {
            ...
            return new CampaignControllerActionDeclineUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                legacyActionId,
