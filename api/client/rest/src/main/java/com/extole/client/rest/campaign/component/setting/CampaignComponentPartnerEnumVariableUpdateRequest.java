...
public final class CampaignComponentPartnerEnumVariableUpdateRequest
    ...
    @JsonCreator
    private CampaignComponentPartnerEnumVariableUpdateRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        extends
        CampaignComponentVariableUpdateRequest.Builder<CALLER, CampaignComponentPartnerEnumVariableUpdateRequest,
        ...
        public CampaignComponentPartnerEnumVariableUpdateRequest build() {
            return new CampaignComponentPartnerEnumVariableUpdateRequest(
                name,
                displayName,
                values,
                source,
