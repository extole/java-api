...
public class DuplicatableComponentListRequest {
    private static final String COMMA = ",";

    private static final String QUERY_PARAM_NAME = "name";
    private static final String QUERY_PARAM_SOURCE_CLIENT_IDS = "source_client_id";
    ...
    private final Optional<String> sourceClientIds;
    ...
    public DuplicatableComponentListRequest(
        @QueryParam(QUERY_PARAM_NAME) @Parameter(
            description = "The name of the component to filter by.") Optional<String> name,
        @QueryParam(QUERY_PARAM_SOURCE_CLIENT_IDS) @Parameter(
            description = "A comma-separated list of source client ids; " +
                "Only components with specified source client ids will be returned.") Optional<String> sourceClientIds,
        ...
        @QueryParam(QUERY_PARAM_VERSION_STATE) @Parameter(
            description = "The version state of the components campaign to filter by.") Optional<
                CampaignVersionState> versionState,
        ...
        @QueryParam(QUERY_PARAM_HAVING_ANY_TYPES) @Parameter(
            description = "A comma-separated list of component types; " +
                "the component must have at least one of these types.") Optional<String> havingAnyTypes,
        @QueryParam(QUERY_PARAM_HAVING_ALL_TYPES) @Parameter(
            description = "A comma-separated list of component types; " +
                "the component must have all of these types.") Optional<String> havingAllTypes,
        ...
        @QueryParam(QUERY_PARAM_SHOW_ALL) @Parameter(
            description = "showAll applies only for components visible due components subscriptions" +
        ...
        this.name = name;
        this.sourceClientIds = sourceClientIds;
        this.state = state;
    ...
    @QueryParam(QUERY_PARAM_SOURCE_CLIENT_IDS)
    public Optional<String> getSourceClientIds() {
        return sourceClientIds;
    }
    ...
    public static final class Builder {
        ...
        private String[] sourceClientIds = new String[] {};
        ...
        public Builder sourceClientIds(String... sourceClientIds) {
            this.sourceClientIds = sourceClientIds;
            return this;
        }
        ...
        public DuplicatableComponentListRequest build() {
            return new DuplicatableComponentListRequest(name,
                getArrayAsCommaJoinedString(sourceClientIds),
