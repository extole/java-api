...
public class CampaignControllerTriggerDataIntelligenceEventUpdateRequest extends CampaignControllerTriggerRequest {

    private static final String EVENT_NAME = "event_name";

    private final Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, String>> eventName;

    public CampaignControllerTriggerDataIntelligenceEventUpdateRequest(
        ...
        @JsonProperty(EVENT_NAME) Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext, String>> eventName,
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerDataIntelligenceEventUpdateRequest build() {
            ...
            return new CampaignControllerTriggerDataIntelligenceEventUpdateRequest(
                triggerPhase,
                name,
