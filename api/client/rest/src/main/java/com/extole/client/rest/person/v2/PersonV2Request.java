...
public class PersonV2Request {
    ...
    public PersonV2Request(@Nullable @JsonProperty(EMAIL) String email,
    ...
    public static final class Builder {
        ...
        public PersonV2Request build() {
            return new PersonV2Request(email, firstName, lastName, pictureUrl, partnerUserId, blocked,
