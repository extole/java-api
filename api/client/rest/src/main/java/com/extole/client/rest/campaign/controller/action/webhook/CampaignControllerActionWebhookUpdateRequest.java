...
public class CampaignControllerActionWebhookUpdateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    public CampaignControllerActionWebhookUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionWebhookUpdateRequest build() {
            ...
            return new CampaignControllerActionWebhookUpdateRequest(
                quality,
                enabled,
                componentIds,
                componentReferences,
