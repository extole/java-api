...
public final class CampaignComponentEnumVariableUpdateRequest extends CampaignComponentVariableUpdateRequest {
    ...
    @JsonCreator
    private CampaignComponentEnumVariableUpdateRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        ...
        @Override
        public CampaignComponentEnumVariableUpdateRequest build() {
            return new CampaignComponentEnumVariableUpdateRequest(
                name,
                displayName,
                values,
                source,
