...
public class CampaignComponentPartnerEnumVariableResponse extends CampaignComponentVariableResponse {
    ...
    @JsonCreator
    public CampaignComponentPartnerEnumVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
