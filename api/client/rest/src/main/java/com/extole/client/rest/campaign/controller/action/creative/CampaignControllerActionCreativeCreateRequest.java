...
public final class CampaignControllerActionCreativeCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    private CampaignControllerActionCreativeCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionCreativeCreateRequest build() {
            ...
            return new CampaignControllerActionCreativeCreateRequest(
                quality,
                enabled,
                componentIds,
                componentReferences,
