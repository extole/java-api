...
public class CampaignControllerActionSignalCreateRequest extends ComponentElementRequest {
    ...
    @JsonCreator
    public CampaignControllerActionSignalCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionSignalCreateRequest build() {
            ...
            return new CampaignControllerActionSignalCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                signalPollingId,
