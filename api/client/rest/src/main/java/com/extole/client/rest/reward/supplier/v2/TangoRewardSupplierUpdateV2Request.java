...
public class TangoRewardSupplierUpdateV2Request extends ComponentElementRequest {
    ...
    public TangoRewardSupplierUpdateV2Request(
    ...
    public static TangoRewardSupplierUpdateV2Request.Builder builder() {
        return new TangoRewardSupplierUpdateV2Request.Builder();
    }
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public TangoRewardSupplierUpdateV2Request build() {
            ...
            return new TangoRewardSupplierUpdateV2Request(partnerRewardSupplierId,
                displayType,
                name,
