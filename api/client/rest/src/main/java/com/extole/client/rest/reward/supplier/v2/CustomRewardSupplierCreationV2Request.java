...
public class CustomRewardSupplierCreationV2Request extends ComponentElementRequest {
    ...
    public static CustomRewardSupplierCreationRequestBuilder builder() {
        return new CustomRewardSupplierCreationRequestBuilder();
    }
    ...
    public static final class CustomRewardSupplierCreationRequestBuilder
        ...
        private CustomRewardSupplierCreationRequestBuilder() {
        }
        ...
        public CustomRewardSupplierCreationRequestBuilder withFaceValueAlgorithmType(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, FaceValueAlgorithmType> faceValueAlgorithmType) {
            this.faceValueAlgorithmType = Omissible.of(faceValueAlgorithmType);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withFaceValue(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, BigDecimal> faceValue) {
            this.faceValue = Omissible.of(faceValue);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withCashBackPercentage(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, BigDecimal> cashBackPercentage) {
            this.cashBackPercentage = Omissible.of(cashBackPercentage);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withMinCashBack(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, BigDecimal> minCashBack) {
            this.minCashBack = Omissible.of(minCashBack);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withMaxCashBack(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, BigDecimal> maxCashBack) {
            this.maxCashBack = Omissible.of(maxCashBack);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withFaceValueType(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, FaceValueType> faceValueType) {
            this.faceValueType = faceValueType;
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withPartnerRewardSupplierId(String partnerRewardSupplierId) {
            this.partnerRewardSupplierId = Omissible.of(partnerRewardSupplierId);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withPartnerRewardKeyType(
            PartnerRewardKeyType partnerRewardKeyType) {
            this.partnerRewardKeyType = Omissible.of(partnerRewardKeyType);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withDisplayType(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, String> displayType) {
            this.displayType = Omissible.of(displayType);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withType(CustomRewardType type) {
            this.type = type;
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder
        ...
        public CustomRewardSupplierCreationRequestBuilder withLimitPerDay(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, Optional<Integer>> limitPerDay) {
            this.limitPerDay = Omissible.of(limitPerDay);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withLimitPerHour(
            BuildtimeEvaluatable<RewardSupplierBuildtimeContext, Optional<Integer>> limitPerHour) {
            this.limitPerHour = Omissible.of(limitPerHour);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withTags(Set<String> tags) {
            this.tags = Omissible.of(tags);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder
            withData(Map<String, BuildtimeEvaluatable<RewardSupplierBuildtimeContext, String>> data) {
            this.data = Omissible.of(data);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder
            withEnabled(BuildtimeEvaluatable<RewardSupplierBuildtimeContext, Boolean> enabled) {
            this.enabled = Omissible.of(enabled);
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder
            withStateTransitions(Map<RewardState, List<RewardState>> stateTransitions) {
            this.stateTransitions = Omissible.of(stateTransitions);
            return this;
        }

        public CustomRewardSupplierCreationV2Request build() {
        ...
        public CustomRewardSupplierCreationRequestBuilder withName(String name) {
        ...
        public CustomRewardSupplierCreationRequestBuilder withFaceValue(BigDecimal faceValue) {
            this.faceValue = Omissible.of(Provided.of(faceValue));
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withCashBackPercentage(BigDecimal cashBackPercentage) {
            this.cashBackPercentage = Omissible.of(Provided.of(cashBackPercentage));
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withMinCashBack(BigDecimal minCashBack) {
            this.minCashBack = Omissible.of(Provided.of(minCashBack));
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withMaxCashBack(BigDecimal maxCashBack) {
            this.maxCashBack = Omissible.of(Provided.of(maxCashBack));
            return this;
        }

        public CustomRewardSupplierCreationRequestBuilder withFaceValueType(FaceValueType faceValueType) {
