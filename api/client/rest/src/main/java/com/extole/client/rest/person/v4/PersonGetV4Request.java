...
public class PersonGetV4Request {
    ...
    public static final class Builder {
        ...
        public PersonGetV4Request build() {
            return new PersonGetV4Request(email, partnerUserId, lastName, limit, offset, partnerIds);
        }
