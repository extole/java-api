...
public class ManualCouponRewardSupplierCreationV2Request extends ComponentElementRequest {
    ...
    public ManualCouponRewardSupplierCreationV2Request(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public ManualCouponRewardSupplierCreationV2Request build() {
            ...
            return new ManualCouponRewardSupplierCreationV2Request(faceValueType,
