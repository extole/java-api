...
public final class CampaignControllerActionApproveUpdateRequest extends ComponentElementRequest {
    ...
    private final Omissible<String> force;
    ...
    @JsonCreator
    private CampaignControllerActionApproveUpdateRequest(
        ...
        @JsonProperty(JSON_FORCE) Omissible<String> force,
        ...
        @JsonProperty(JSON_REWARD_TAGS) Omissible<BuildtimeEvaluatable<ControllerBuildtimeContext,
            RuntimeEvaluatable<ApproveActionContext, Set<String>>>> rewardTags) {
    ...
    public Omissible<String> getForce() {
        return force;
    }
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        private Omissible<String> force = Omissible.omitted();
        ...
        public Builder withForce(String force) {
        ...
        public Builder withRewardTags(
            BuildtimeEvaluatable<ControllerBuildtimeContext,
                RuntimeEvaluatable<ApproveActionContext, Set<String>>> rewardTags) {
            this.rewardTags = Omissible.of(rewardTags);
            return this;
        }

        public CampaignControllerActionApproveUpdateRequest build() {
            ...
            return new CampaignControllerActionApproveUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                legacyActionId,
