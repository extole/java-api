...
public class CampaignComponentDelayListVariableResponse extends CampaignComponentVariableResponse {
    public static final String SETTING_TYPE = "DELAY_LIST";

    @JsonCreator
    public CampaignComponentDelayListVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
