...
public class CampaignControllerActionStepSignalUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionStepSignalUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionStepSignalUpdateRequest build() {
            ...
            return new CampaignControllerActionStepSignalUpdateRequest(
                quality,
                enabled,
                componentIds,
                componentReferences,
