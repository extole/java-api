...
@Path("/v4/persons/{person_id}/stats")
@Tag(name = "/v4/persons", description = "PersonStats")
public interface PersonStatsEndpoints {

    @Produces(MediaType.APPLICATION_JSON)
    @GET
    @Operation(summary = "Gets calculated statistics for a Person")
    PersonStatsResponse getStats(@UserAccessTokenParam(requiredScope = Scope.USER_SUPPORT) String accessToken,
