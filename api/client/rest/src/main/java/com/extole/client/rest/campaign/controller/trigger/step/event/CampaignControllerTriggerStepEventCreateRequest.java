...
public class CampaignControllerTriggerStepEventCreateRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    public CampaignControllerTriggerStepEventCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        @Override
        public CampaignControllerTriggerStepEventCreateRequest build() {
            ...
            return new CampaignControllerTriggerStepEventCreateRequest(
                triggerPhase,
                name,
