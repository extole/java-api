...
public final class CampaignComponentEnumListVariableRequest extends CampaignComponentVariableRequest {
    ...
    @JsonCreator
    private CampaignComponentEnumListVariableRequest(
    ...
    public static final class Builder<CALLER, BUILDER_TYPE extends Builder<CALLER, BUILDER_TYPE>>
        extends CampaignComponentVariableRequest.Builder<CALLER, CampaignComponentEnumListVariableRequest,
        ...
        @Override
        public CampaignComponentEnumListVariableRequest build() {
            return new CampaignComponentEnumListVariableRequest(
                name,
                displayName,
                type,
                values,
