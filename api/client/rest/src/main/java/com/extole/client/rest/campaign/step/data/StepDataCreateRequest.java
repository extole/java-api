...
public class StepDataCreateRequest extends ComponentElementRequest {
    ...
    public StepDataCreateRequest(@JsonProperty(JSON_NAME) BuildtimeEvaluatable<CampaignBuildtimeContext, String> name,
    ...
    public static final class Builder<T> extends ComponentElementRequest.Builder<Builder<T>> {
        ...
        @Override
        public StepDataCreateRequest build() {
            ...
            return new StepDataCreateRequest(name,
                value,
                scope,
                dimension,
                persistTypes,
