...
public class CampaignControllerActionExpressionCreateRequest extends ComponentElementRequest {
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionExpressionCreateRequest build() {
            ...
            return new CampaignControllerActionExpressionCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                expression,
