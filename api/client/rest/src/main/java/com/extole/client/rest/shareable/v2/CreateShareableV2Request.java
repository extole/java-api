...
public final class CreateShareableV2Request {
    ...
    @JsonCreator
    public CreateShareableV2Request(
    ...
    public static final class Builder {
        ...
        public CreateShareableV2Request build() {
            return new CreateShareableV2Request(key, code, targetUrl, content, consumerEvent, data, label);
        }
    }
}
