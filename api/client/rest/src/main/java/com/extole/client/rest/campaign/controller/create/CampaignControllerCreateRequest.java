...
public final class CampaignControllerCreateRequest extends CampaignStepCreateRequest {
    ...
    @JsonCreator
    public CampaignControllerCreateRequest(
    ...
    public static final class Builder
        extends CampaignStepCreateRequest.Builder<Builder, CampaignControllerCreateRequest> {
        ...
        private final List<StepDataCreateRequest.Builder<?>> dataBuilders = Lists.newArrayList();
        private Omissible<BuildtimeEvaluatable<CampaignBuildtimeContext, Set<String>>> journeyNames =
            Omissible.omitted();
        private Omissible<BuildtimeEvaluatable<CampaignBuildtimeContext, SendPolicy>> sendPolicy =
            Omissible.omitted();
        ...
        @Override
        public CampaignControllerCreateRequest build() {
            ...
            return new CampaignControllerCreateRequest(
                enabled,
                componentIds,
                componentReferences,
                name,
