...
public final class CampaignControllerTriggerClientDomainUpdateRequest extends CampaignControllerTriggerRequest {
    ...
    @JsonCreator
    private CampaignControllerTriggerClientDomainUpdateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public CampaignControllerTriggerClientDomainUpdateRequest build() {
            ...
            return new CampaignControllerTriggerClientDomainUpdateRequest(triggerPhase,
                name,
