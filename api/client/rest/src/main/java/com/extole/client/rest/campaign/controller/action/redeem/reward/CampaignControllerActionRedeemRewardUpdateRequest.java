...
public class CampaignControllerActionRedeemRewardUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionRedeemRewardUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionRedeemRewardUpdateRequest build() {
            ...
            return new CampaignControllerActionRedeemRewardUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                rewardId,
