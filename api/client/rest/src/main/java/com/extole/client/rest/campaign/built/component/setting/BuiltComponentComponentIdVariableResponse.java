...
public class BuiltComponentComponentIdVariableResponse extends BuiltCampaignComponentVariableResponse {
    ...
    @JsonCreator
    public BuiltComponentComponentIdVariableResponse(@JsonProperty(JSON_COMPONENT_SETTING_NAME) String name,
