...
public class CampaignControllerActionCancelRewardUpdateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionCancelRewardUpdateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionCancelRewardUpdateRequest build() {
            ...
            return new CampaignControllerActionCancelRewardUpdateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                rewardId,
