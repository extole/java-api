...
public class CampaignControllerActionCancelRewardCreateRequest extends ComponentElementRequest {
    ...
    public CampaignControllerActionCancelRewardCreateRequest(
    ...
    public static final class Builder extends ComponentElementRequest.Builder<Builder> {
        ...
        public CampaignControllerActionCancelRewardCreateRequest build() {
            ...
            return new CampaignControllerActionCancelRewardCreateRequest(quality,
                enabled,
                componentIds,
                componentReferences,
                rewardId,
