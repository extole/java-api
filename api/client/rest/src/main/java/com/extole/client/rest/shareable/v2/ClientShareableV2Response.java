...
public final class ClientShareableV2Response {

    private static final String JSON_PROPERTY_PERSON = "person_id";
    ...
    @JsonCreator
    public ClientShareableV2Response(
        @JsonProperty(JSON_PROPERTY_PERSON) String personId,
