...
public class CampaignControllerTriggerZoneStateCreateRequest extends CampaignControllerTriggerRequest {
    ...
    public CampaignControllerTriggerZoneStateCreateRequest(
    ...
    public static final class Builder extends CampaignControllerTriggerRequest.Builder<Builder> {
        ...
        public Builder withZoneName(BuildtimeEvaluatable<ControllerBuildtimeContext, Optional<String>> zoneName) {
            this.zoneName = Omissible.of(zoneName);
            return this;
        }

        public Builder withStepName(BuildtimeEvaluatable<ControllerBuildtimeContext, Optional<String>> stepName) {
        ...
        public CampaignControllerTriggerZoneStateCreateRequest build() {
            ...
            return new CampaignControllerTriggerZoneStateCreateRequest(triggerPhase,
                name,
