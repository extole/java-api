...
public class PersonStepV2Response {
    ...
    private final PartnerEventIdV2Response partnerEventId;
    ...
    public PersonStepV2Response(
        ...
        @Nullable @JsonProperty(PARTNER_EVENT_ID) PartnerEventIdV2Response partnerEventId,
    ...
    public PartnerEventIdV2Response getPartnerEventId() {
