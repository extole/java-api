...
public class CampaignComponentAssetCreateRequest {
    ...
    @JsonCreator
    public CampaignComponentAssetCreateRequest(@JsonProperty(NAME) Omissible<String> name,
    ...
    public static final class Builder {
        ...
        public CampaignComponentAssetCreateRequest build() {
            return new CampaignComponentAssetCreateRequest(name,
                tags,
                description);
        }
    }
