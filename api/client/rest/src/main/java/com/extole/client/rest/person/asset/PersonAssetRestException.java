...
public class PersonAssetRestException extends ExtoleRestException {
    ...
    public static final ErrorCode<PersonAssetRestException> ASSET_CONTENT_NOT_DOWNLOADED =
        new ErrorCode<>("asset_content_not_found", 400, "Asset content could not be downloaded", "person_id",
            "asset_id");
