...
public class BuiltCampaignControllerTriggerHasIdentityResponse extends BuiltCampaignControllerTriggerResponse {

    public BuiltCampaignControllerTriggerHasIdentityResponse(
        ...
        super(triggerId, CampaignControllerTriggerType.HAS_IDENTITY, triggerPhase, name, description, enabled, negated,
