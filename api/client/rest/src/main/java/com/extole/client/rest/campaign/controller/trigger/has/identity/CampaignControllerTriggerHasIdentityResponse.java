...
public class CampaignControllerTriggerHasIdentityResponse extends CampaignControllerTriggerResponse {

    public CampaignControllerTriggerHasIdentityResponse(
        ...
        super(triggerId, CampaignControllerTriggerType.HAS_IDENTITY, triggerPhase, name, parentTriggerGroupName,
