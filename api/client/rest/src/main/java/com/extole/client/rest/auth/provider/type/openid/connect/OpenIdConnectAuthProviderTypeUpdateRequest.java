...
public class OpenIdConnectAuthProviderTypeUpdateRequest {
    ...
    public OpenIdConnectAuthProviderTypeUpdateRequest(@Nullable @JsonProperty(NAME) String name,
        @Nullable @JsonProperty(DOMAIN) String domain,
        @Nullable @JsonProperty(APPLICATION_ID) String applicationId,
        @Nullable @JsonProperty(APPLICATION_SECRET) String applicationSecret,
        @Nullable @JsonProperty(CUSTOM_PARAMS) Map<String, String> customParams,
        @Nullable @JsonProperty(SCOPES) Set<Scope> scopes,
        @Nullable @JsonProperty(CATEGORY) Category category,
    ...
    public static final class Builder {
        ...
        public OpenIdConnectAuthProviderTypeUpdateRequest build() {
            return new OpenIdConnectAuthProviderTypeUpdateRequest(name,
                domain,
                applicationId,
                applicationSecret,
                customParams,
