...
@Component
public class OAuthOptimoveClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<OAuthOptimoveClientKey, OAuthOptimoveClientKeyResponse> {

    @Autowired
    public OAuthOptimoveClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public OAuthOptimoveClientKeyResponse toResponse(OAuthOptimoveClientKey clientKey, ZoneId timeZone) {
        return new OAuthOptimoveClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
