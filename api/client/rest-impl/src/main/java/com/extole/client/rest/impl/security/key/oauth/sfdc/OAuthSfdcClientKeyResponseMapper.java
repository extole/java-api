...
@Component
public class OAuthSfdcClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<OAuthSfdcClientKey, OAuthSfdcClientKeyResponse> {

    @Autowired
    public OAuthSfdcClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public OAuthSfdcClientKeyResponse toResponse(OAuthSfdcClientKey clientKey, ZoneId timeZone) {
        return new OAuthSfdcClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
