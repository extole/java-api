...
@Component
public class OAuthListrakClientKeyCreateRequestMapper
    extends OAuthClientKeyCreateRequestMapper<OAuthListrakClientKeyCreateRequest, OAuthListrakClientKey> {

    @Autowired
    public OAuthListrakClientKeyCreateRequestMapper(ClientKeyService clientKeyService,
