...
@Component
public class OAuthLeadPerfectionClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<OAuthLeadPerfectionClientKey, OAuthLeadPerfectionClientKeyResponse> {

    @Autowired
    public OAuthLeadPerfectionClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public OAuthLeadPerfectionClientKeyResponse toResponse(OAuthLeadPerfectionClientKey clientKey, ZoneId timeZone) {
        return new OAuthLeadPerfectionClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
