...
import com.extole.model.entity.campaign.built.BuiltCampaignControllerActionRemoveMembership;

@Component
public class BuiltCampaignControllerActionRemoveMembershipResponseMapper implements
    BuiltCampaignControllerActionResponseMapper<BuiltCampaignControllerActionRemoveMembership,
        BuiltCampaignControllerActionRemoveMembershipResponse> {

    @Override
    public BuiltCampaignControllerActionRemoveMembershipResponse
        toResponse(BuiltCampaignControllerActionRemoveMembership action, ZoneId timeZone) {
        return new BuiltCampaignControllerActionRemoveMembershipResponse(
