...
public class CampaignControllerTriggerAudienceMembershipResponseMapper implements
    ...
    @Autowired
    public CampaignControllerTriggerAudienceMembershipResponseMapper(
        CampaignComponentRestMapper campaignComponentRestMapper) {
        this.campaignComponentRestMapper = campaignComponentRestMapper;
    }

    @Override
    public CampaignControllerTriggerAudienceMembershipResponse toResponse(
    ...
    @Override
    public CampaignControllerTriggerAudienceMembershipConfiguration toConfiguration(
        CampaignControllerTriggerAudienceMembership trigger, ZoneId timeZone,
        Map<Id<CampaignComponent>, String> componentNames) {
        return new CampaignControllerTriggerAudienceMembershipConfiguration(
