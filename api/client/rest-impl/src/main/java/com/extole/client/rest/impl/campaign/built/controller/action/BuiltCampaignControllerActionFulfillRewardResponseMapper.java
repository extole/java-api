...
import com.extole.model.entity.campaign.built.BuiltCampaignControllerActionFulfillReward;

@Component
public class BuiltCampaignControllerActionFulfillRewardResponseMapper implements
    BuiltCampaignControllerActionResponseMapper<BuiltCampaignControllerActionFulfillReward,
        BuiltCampaignControllerActionFulfillRewardResponse> {

    @Override
    public BuiltCampaignControllerActionFulfillRewardResponse
        toResponse(BuiltCampaignControllerActionFulfillReward action, ZoneId timeZone) {
        return new BuiltCampaignControllerActionFulfillRewardResponse(
