...
import com.extole.client.rest.security.key.SslPkcs12ClientKeyResponse;
...
@Component
public class SslPkcs12ClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<SslPkcs12ClientKey, SslPkcs12ClientKeyResponse> {

    private final EncryptionService<byte[]> encryptionService;

    public SslPkcs12ClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
        this.encryptionService = encryptionService;
    }

    @Override
    public SslPkcs12ClientKeyResponse toResponse(SslPkcs12ClientKey clientKey, ZoneId timeZone) {
        return new SslPkcs12ClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
    ...
    private Optional<String> maskPassword(SslPkcs12ClientKey clientKey) {
