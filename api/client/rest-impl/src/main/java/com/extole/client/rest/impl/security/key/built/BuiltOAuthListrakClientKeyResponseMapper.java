...
import com.extole.client.rest.security.key.built.BuiltOAuthListrakClientKeyResponse;
import com.extole.id.Id;
import com.extole.model.entity.client.security.key.ClientKey;
import com.extole.model.entity.client.security.key.built.BuiltOAuthListrakClientKey;
import com.extole.model.service.encryption.EncryptionService;

@Component
public class BuiltOAuthListrakClientKeyResponseMapper
    extends BuiltBaseClientKeyResponseMapper<BuiltOAuthListrakClientKey, BuiltOAuthListrakClientKeyResponse> {

    @Autowired
    public BuiltOAuthListrakClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public BuiltOAuthListrakClientKeyResponse toResponse(BuiltOAuthListrakClientKey clientKey, ZoneId timeZone) {
        return new BuiltOAuthListrakClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
    ...
    public ClientKey.Algorithm getAlgorithm() {
        return ClientKey.Algorithm.OAUTH_LISTRAK;
    }
