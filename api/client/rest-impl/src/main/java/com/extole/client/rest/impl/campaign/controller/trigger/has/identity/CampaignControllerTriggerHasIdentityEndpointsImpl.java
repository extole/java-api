package com.extole.client.rest.impl.campaign.controller.trigger.has.identity;
...
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.HAS_IDENTITY;
...
import com.extole.client.rest.campaign.controller.trigger.has.identity.CampaignControllerTriggerHasIdentityCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.has.identity.CampaignControllerTriggerHasIdentityEndpoints;
import com.extole.client.rest.campaign.controller.trigger.has.identity.CampaignControllerTriggerHasIdentityResponse;
import com.extole.client.rest.campaign.controller.trigger.has.identity.CampaignControllerTriggerHasIdentityUpdateRequest;
...
@Provider
public class CampaignControllerTriggerHasIdentityEndpointsImpl
    implements CampaignControllerTriggerHasIdentityEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerHasIdentityResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerHasIdentityEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerHasIdentityResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerHasIdentityResponse create(String accessToken,
        String campaignId,
        ...
        try {
            CampaignControllerTriggerHasIdentityBuilder triggerBuilder =
                campaignBuilder.updateStep(step)
                    .addTrigger(HAS_IDENTITY);
    ...
    @Override
    public CampaignControllerTriggerHasIdentityResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerHasIdentity trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getHasIdentityStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerHasIdentityBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
    ...
    @Override
    public CampaignControllerTriggerHasIdentityResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerHasIdentityResponse get(String accessToken,
        String campaignId,
        String version,
        String controllerId,
        String triggerId)
        ...
        CampaignControllerTriggerHasIdentity trigger =
            campaignStepProvider.getHasIdentityStepTrigger(campaign, controllerId, triggerId);
