...
import com.extole.client.rest.campaign.built.component.setting.BuiltComponentPartnerEnumVariableResponse;
...
import com.extole.model.entity.campaign.BuiltPartnerEnumVariable;
...
@Component
public class BuiltComponentPartnerEnumVariableRestMapper
    implements BuiltComponentSettingRestMapper<BuiltComponentPartnerEnumVariableResponse> {
    @Override
    public BuiltComponentPartnerEnumVariableResponse mapToSettingResponse(BuiltCampaign campaign,
        String componentId,
        BuiltSetting setting) {
        BuiltPartnerEnumVariable partnerVariable = (BuiltPartnerEnumVariable) setting;
        return new BuiltComponentPartnerEnumVariableResponse(setting.getName(),
