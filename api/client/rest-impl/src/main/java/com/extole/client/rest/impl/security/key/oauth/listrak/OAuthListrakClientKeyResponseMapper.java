...
@Component
public class OAuthListrakClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<OAuthListrakClientKey, OAuthListrakClientKeyResponse> {

    @Autowired
    public OAuthListrakClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public OAuthListrakClientKeyResponse toResponse(OAuthListrakClientKey clientKey, ZoneId timeZone) {
        return new OAuthListrakClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
