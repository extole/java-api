...
import com.extole.client.rest.campaign.controller.response.CampaignControllerResponse;
...
@Component
public class CampaignControllerResponseMapper implements
    CampaignStepResponseMapper<CampaignController, CampaignControllerResponse, CampaignControllerConfiguration> {
    ...
    @Autowired
    public CampaignControllerResponseMapper(
    ...
    @Override
    public CampaignControllerResponse toResponse(CampaignController controller, ZoneId timeZone) {

        return new CampaignControllerResponse(
            ...
            Evaluatables.remapEnumCollection(controller.getSelectors(), new TypeReference<>() {}),
    ...
    @Override
    public CampaignControllerConfiguration toConfiguration(CampaignController controller, ZoneId timeZone,
        Map<Id<CampaignComponent>, String> componentNames) {

        return new CampaignControllerConfiguration(
