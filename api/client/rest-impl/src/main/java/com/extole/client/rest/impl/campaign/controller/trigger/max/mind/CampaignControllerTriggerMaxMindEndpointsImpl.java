...
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.MAXMIND;
...
import com.extole.client.rest.campaign.controller.trigger.max.mind.CampaignControllerTriggerMaxMindEndpoints;
...
@Provider
public class CampaignControllerTriggerMaxMindEndpointsImpl implements CampaignControllerTriggerMaxMindEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerMaxMindResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerMaxMindEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerMaxMindResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerMaxMindResponse create(String accessToken,
        String campaignId,
        ...
        try {
            CampaignControllerTriggerMaxMindBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
                .addTrigger(MAXMIND);
            ...
            request.getDefaultQualityScore()
                .ifPresent(value -> triggerBuilder
                    .withDefaultQualityScore(Evaluatables.remapEnum(value, new TypeReference<>() {})));
            request.getRiskThreshold().ifPresent(value -> triggerBuilder.withRiskThreshold(value));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignUpdateRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerMaxMindThresholdValueException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerMaxMindValidationRestException.class)
                .withErrorCode(CampaignControllerTriggerMaxMindValidationRestException.INVALID_THRESHOLD)
                .addParameter("campaign_id", campaignId)
    ...
    @Override
    public CampaignControllerTriggerMaxMindResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerMaxMind trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getMaxMindStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
    ...
    @Override
    public CampaignControllerTriggerMaxMindResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerMaxMindResponse get(String accessToken,
        String campaignId, String version, String controllerId, String triggerId) throws UserAuthorizationRestException,
        ...
        CampaignControllerTriggerMaxMind trigger =
            campaignStepProvider.getMaxMindStepTrigger(campaign, controllerId, triggerId);
