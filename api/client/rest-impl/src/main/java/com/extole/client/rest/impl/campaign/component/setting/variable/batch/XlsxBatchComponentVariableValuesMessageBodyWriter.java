...
@Produces(ExtoleMediaType.APPLICATION_EXCEL)
public class XlsxBatchComponentVariableValuesMessageBodyWriter
    ...
    public void writeTo(List<BatchComponentVariableValues> response, Class<?> type, Type genericType,
        ...
        FileContentWriteStrategy fileFormatParseStrategy =
            FileContentParser.getWriteStrategy(FileContentParseFormat.XLSX);
