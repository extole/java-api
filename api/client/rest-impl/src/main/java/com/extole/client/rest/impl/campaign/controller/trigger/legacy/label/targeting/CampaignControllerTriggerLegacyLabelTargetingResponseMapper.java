...
public class CampaignControllerTriggerLegacyLabelTargetingResponseMapper implements
    ...
    @Autowired
    public CampaignControllerTriggerLegacyLabelTargetingResponseMapper(
        CampaignComponentRestMapper campaignComponentRestMapper) {
        this.campaignComponentRestMapper = campaignComponentRestMapper;
    }

    @Override
    public CampaignControllerTriggerLegacyLabelTargetingResponse toResponse(
        CampaignControllerTriggerLegacyLabelTargeting trigger, ZoneId timeZone) {
    ...
    @Override
    public CampaignControllerTriggerLegacyLabelTargetingConfiguration toConfiguration(
        CampaignControllerTriggerLegacyLabelTargeting trigger,
        ZoneId timeZone,
        Map<Id<CampaignComponent>, String> componentNames) {
        return new CampaignControllerTriggerLegacyLabelTargetingConfiguration(
