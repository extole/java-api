...
@Component
public class CampaignControllerTriggerHasIdentityUploader
    implements CampaignControllerTriggerUploader<CampaignControllerTriggerHasIdentityConfiguration> {

    @Override
    public void upload(CampaignUploadContext context, CampaignStepConfiguration step,
        CampaignControllerTriggerHasIdentityConfiguration trigger, ZoneId timeZone)
        throws CampaignComponentValidationRestException {
        CampaignControllerTriggerHasIdentityBuilder triggerBuilder = context.get(step, trigger);
