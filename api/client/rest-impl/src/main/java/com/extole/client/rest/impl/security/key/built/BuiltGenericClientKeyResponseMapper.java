...
import com.extole.client.rest.security.key.built.BuiltGenericClientKeyResponse;
...
@Component
public class BuiltGenericClientKeyResponseMapper
    extends BuiltBaseClientKeyResponseMapper<BuiltClientKey, BuiltGenericClientKeyResponse> {

    public BuiltGenericClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public BuiltGenericClientKeyResponse toResponse(BuiltClientKey clientKey, ZoneId timeZone) {
        return new BuiltGenericClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
