...
import com.extole.client.rest.campaign.built.controller.BuiltCampaignFrontendControllerResponse;
...
@Component
class BuiltCampaignFrontendControllerResponseMapper
    implements BuiltCampaignStepResponseMapper<BuiltFrontendController, BuiltCampaignFrontendControllerResponse> {
    ...
    @Autowired
    BuiltCampaignFrontendControllerResponseMapper(
    ...
    @Override
    public BuiltCampaignFrontendControllerResponse toResponse(BuiltFrontendController controller, ZoneId timeZone) {

        return new BuiltCampaignFrontendControllerResponse(
