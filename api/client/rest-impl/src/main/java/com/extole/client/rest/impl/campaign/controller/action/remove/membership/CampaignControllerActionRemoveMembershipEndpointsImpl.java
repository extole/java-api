...
import com.extole.client.rest.campaign.controller.action.remove.membership.CampaignControllerActionRemoveMembershipCreateRequest;
import com.extole.client.rest.campaign.controller.action.remove.membership.CampaignControllerActionRemoveMembershipEndpoints;
...
import com.extole.client.rest.campaign.controller.action.remove.membership.CampaignControllerActionRemoveMembershipUpdateRequest;
import com.extole.client.rest.campaign.controller.action.remove.membership.CampaignControllerActionRemoveMembershipValidationRestException;
...
import com.extole.model.service.campaign.controller.action.remove.membership.CampaignControllerActionRemoveMembershipInvalidAudienceIdException;
...
@Provider
public class CampaignControllerActionRemoveMembershipEndpointsImpl
    implements CampaignControllerActionRemoveMembershipEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerActionRemoveMembershipResponseMapper responseMapper;
    ...
    @Autowired
    public CampaignControllerActionRemoveMembershipEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerActionRemoveMembershipResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerActionRemoveMembershipResponse create(String accessToken,
        String campaignId,
        ...
        try {
            ...
            CampaignControllerActionRemoveMembershipBuilder actionBuilder = campaignBuilder
                .updateController(controller)
                .addAction(CampaignControllerActionType.REMOVE_MEMBERSHIP);
            ...
            throw RestExceptionBuilder.newBuilder(CampaignComponentValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerActionRemoveMembershipInvalidAudienceIdException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerActionRemoveMembershipValidationRestException.class)
                .withErrorCode(CampaignControllerActionRemoveMembershipValidationRestException.AUDIENCE_NOT_FOUND)
    ...
    @Override
    public CampaignControllerActionRemoveMembershipResponse get(String accessToken,
        String campaignId,
        String version,
        String controllerId,
        String actionId)
        ...
        CampaignControllerActionRemoveMembership action =
            campaignStepProvider.getRemoveMembershipControllerAction(campaign, controllerId, actionId);
        return responseMapper.toResponse(action, ZoneOffset.UTC);
    }

    @Override
    public CampaignControllerActionRemoveMembershipResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId,
    ...
    @Override
    public CampaignControllerActionRemoveMembershipResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId)
