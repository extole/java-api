...
import com.extole.model.entity.campaign.built.BuiltCampaignControllerActionShareEvent;
...
public class BuiltCampaignControllerActionShareEventResponseMapper implements
    ...
    @Override
    public BuiltCampaignControllerActionShareEventResponse toResponse(BuiltCampaignControllerActionShareEvent action,
        ZoneId timeZone) {
