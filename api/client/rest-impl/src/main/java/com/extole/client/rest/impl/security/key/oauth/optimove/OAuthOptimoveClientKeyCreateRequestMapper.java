...
@Component
public class OAuthOptimoveClientKeyCreateRequestMapper
    extends OAuthClientKeyCreateRequestMapper<OAuthOptimoveClientKeyCreateRequest, OAuthOptimoveClientKey> {

    @Autowired
    public OAuthOptimoveClientKeyCreateRequestMapper(ClientKeyService clientKeyService,
