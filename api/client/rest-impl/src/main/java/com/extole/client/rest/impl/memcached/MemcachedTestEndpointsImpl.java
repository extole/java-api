...
@Singleton
@Beta
@Path("/v2/test/memcached")
public class MemcachedTestEndpointsImpl {
    private static final Logger LOG = LoggerFactory.getLogger(MemcachedTestEndpointsImpl.class);
    private static final String STORE_NAME = "memcached-test-endpoint";

    private final ExtoleMemcachedClient<String, String> memcachedClient;

    @Autowired
    public MemcachedTestEndpointsImpl(TestMemcachedFactory memcachedFactory) {
