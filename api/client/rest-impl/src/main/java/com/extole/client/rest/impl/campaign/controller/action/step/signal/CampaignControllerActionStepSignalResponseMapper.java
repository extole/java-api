...
public class CampaignControllerActionStepSignalResponseMapper implements
    ...
    @Autowired
    public CampaignControllerActionStepSignalResponseMapper(CampaignComponentRestMapper campaignComponentRestMapper) {
        this.campaignComponentRestMapper = campaignComponentRestMapper;
    }

    @Override
    public CampaignControllerActionStepSignalResponse
        toResponse(CampaignControllerActionStepSignal action, ZoneId timeZone) {
        return new CampaignControllerActionStepSignalResponse(action.getId().getValue(),
    ...
    public CampaignControllerActionStepSignalConfiguration
        toConfiguration(CampaignControllerActionStepSignal action, ZoneId timeZone,
            Map<Id<CampaignComponent>, String> componentNames) {
        return new CampaignControllerActionStepSignalConfiguration(Omissible.of(Id.valueOf(action.getId().getValue())),
