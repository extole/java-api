...
import com.extole.model.entity.campaign.built.BuiltCampaignControllerActionSignal;

@Component
public class BuiltCampaignControllerActionSignalResponseMapper implements
    BuiltCampaignControllerActionResponseMapper<BuiltCampaignControllerActionSignal,
        BuiltCampaignControllerActionSignalResponse> {

    @Override
    public BuiltCampaignControllerActionSignalResponse
        toResponse(BuiltCampaignControllerActionSignal action, ZoneId timeZone) {
        return new BuiltCampaignControllerActionSignalResponse(action.getId().getValue(),
