...
import com.extole.client.rest.campaign.controller.trigger.referred.by.CampaignControllerTriggerReferredByEventCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.referred.by.CampaignControllerTriggerReferredByEventEndpoints;
import com.extole.client.rest.campaign.controller.trigger.referred.by.CampaignControllerTriggerReferredByEventResponse;
import com.extole.client.rest.campaign.controller.trigger.referred.by.CampaignControllerTriggerReferredByEventUpdateRequest;
import com.extole.client.rest.campaign.controller.trigger.referred.by.CampaignControllerTriggerReferredByEventValidationRestException;
...
@Provider
public class CampaignControllerTriggerReferredByEventEndpointsImpl
    implements CampaignControllerTriggerReferredByEventEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerReferredByEventResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerReferredByEventEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerReferredByEventResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerReferredByEventResponse create(String accessToken,
        String campaignId,
        ...
        try {
            CampaignControllerTriggerReferredByEventBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
                .addTrigger(CampaignControllerTriggerType.REFERRED_BY_EVENT);
            request.getTriggerPhase()
                .ifPresent(
                    phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));
            if (request.getReferralOriginator() != null) {
                try {
                    triggerBuilder.withReferralOriginator(
                        CampaignControllerTriggerReferralOriginator.valueOf(request.getReferralOriginator().name()));
                } catch (IllegalArgumentException e) {
                    throw RestExceptionBuilder
                        .newBuilder(CampaignControllerTriggerReferredByEventValidationRestException.class)
                        .withErrorCode(
    ...
    @Override
    public CampaignControllerTriggerReferredByEventResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerReferredByEvent trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getReferredByEventStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerReferredByEventBuilder triggerBuilder =
    ...
    @Override
    public CampaignControllerTriggerReferredByEventResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerReferredByEventResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerTriggerReferredByEvent trigger =
            campaignStepProvider.getReferredByEventStepTrigger(campaign, controllerId, triggerId);
