...
import static com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainValidationRestException.CLIENT_DOMAIN_NOT_FOUND;
import static com.extole.common.rest.exception.FatalRestRuntimeException.SOFTWARE_ERROR;
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.CLIENT_DOMAIN;
...
import com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainEndpoints;
import com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainResponse;
import com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainUpdateRequest;
import com.extole.client.rest.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainValidationRestException;
...
import com.extole.model.service.campaign.controller.trigger.client.domain.CampaignControllerTriggerClientDomainInvalidClientDomainIdException;
import com.extole.model.service.campaign.step.CampaignStepBuildException;

@Provider
public class CampaignControllerTriggerClientDomainEndpointsImpl
    implements CampaignControllerTriggerClientDomainEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerClientDomainResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerClientDomainEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerClientDomainResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerClientDomainResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerClientDomainCreateRequest createRequest)
        throws CampaignRestException, UserAuthorizationRestException, CampaignControllerRestException,
        CampaignControllerTriggerClientDomainValidationRestException, CampaignControllerTriggerValidationRestException,
        ...
        try {
            CampaignControllerTriggerClientDomainBuilder triggerBuilder =
                campaignBuilder.updateStep(step)
                    .addTrigger(CLIENT_DOMAIN);

            createRequest.getName().ifPresent(name -> triggerBuilder.withName(name));
            createRequest.getParentTriggerGroupName().ifPresent(
                parentTriggerGroupName -> triggerBuilder.withParentTriggerGroupName(parentTriggerGroupName));
            ...
            createRequest.getClientDomainIds()
                .ifPresent(clientDomainIds -> triggerBuilder.withClientDomainIds(clientDomainIds));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignComponentValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerClientDomainInvalidClientDomainIdException e) {
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerTriggerClientDomainValidationRestException.class)
                .withErrorCode(CLIENT_DOMAIN_NOT_FOUND)
                .addParameter("client_domain_id", e.getClientDomainId())
                .withCause(e)
                .build();
    ...
    @Override
    public CampaignControllerTriggerClientDomainResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerClientDomainUpdateRequest updateRequest)
        ...
        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getClientDomainStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerClientDomainBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
                .updateTrigger(trigger);

            updateRequest.getName().ifPresent(name -> triggerBuilder.withName(name));
            updateRequest.getParentTriggerGroupName().ifPresent(
                parentTriggerGroupName -> triggerBuilder.withParentTriggerGroupName(parentTriggerGroupName));
            ...
            updateRequest.getTriggerPhase().ifPresent(
                phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));
            updateRequest.getClientDomainIds()
                .ifPresent(clientDomainIds -> triggerBuilder.withClientDomainIds(clientDomainIds));
    ...
    @Override
    public CampaignControllerTriggerClientDomainResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerClientDomainResponse get(String accessToken, String campaignId,
        ...
        CampaignControllerTriggerClientDomain trigger =
            campaignStepProvider.getClientDomainStepTrigger(campaign, controllerId, triggerId);
