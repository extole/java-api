...
import com.extole.client.rest.security.key.built.BuiltOAuthSalesforceClientKeyResponse;
import com.extole.id.Id;
import com.extole.model.entity.client.security.key.ClientKey;
import com.extole.model.entity.client.security.key.built.BuiltOAuthSalesforceClientKey;
import com.extole.model.service.encryption.EncryptionService;

@Component
public class BuiltOAuthSalesforceClientKeyResponseMapper
    extends BuiltBaseClientKeyResponseMapper<BuiltOAuthSalesforceClientKey, BuiltOAuthSalesforceClientKeyResponse> {

    @Autowired
    public BuiltOAuthSalesforceClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public BuiltOAuthSalesforceClientKeyResponse toResponse(BuiltOAuthSalesforceClientKey clientKey, ZoneId timeZone) {
        return new BuiltOAuthSalesforceClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
