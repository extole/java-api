...
import com.extole.client.rest.campaign.controller.action.display.CampaignControllerActionDisplayCreateRequest;
import com.extole.client.rest.campaign.controller.action.display.CampaignControllerActionDisplayEndpoints;
import com.extole.client.rest.campaign.controller.action.display.CampaignControllerActionDisplayResponse;
import com.extole.client.rest.campaign.controller.action.display.CampaignControllerActionDisplayUpdateRequest;
...
import com.extole.client.rest.impl.campaign.built.controller.action.BuiltCampaignControllerActionDisplayResponseMapper;
...
@Provider
public class CampaignControllerActionDisplayEndpointsImpl implements CampaignControllerActionDisplayEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerActionDisplayResponseMapper responseMapper;
    private final BuiltCampaignControllerActionDisplayResponseMapper builtResponseMapper;
    ...
    @Autowired
    public CampaignControllerActionDisplayEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerActionDisplayResponseMapper responseMapper,
        BuiltCampaignControllerActionDisplayResponseMapper builtResponseMapper,
    ...
    @Override
    public CampaignControllerActionDisplayResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerActionDisplayCreateRequest request)
        ...
        try {
            ...
            controller = campaignStepProvider.getFrontendController(campaign, controllerId);
        ...
        try {
            CampaignControllerActionDisplayBuilder actionBuilder = campaignBuilder.updateFrontendController(controller)
                .addAction(CampaignControllerActionType.DISPLAY);
            ...
            request.getBody().ifPresent(body -> actionBuilder.withBody(body));
            request.getHeaders().ifPresent(headers -> actionBuilder.withHeaders(headers));
            request.getResponse().ifPresent(response -> actionBuilder.withResponse(response));
    ...
    @Override
    public CampaignControllerActionDisplayResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId,
        CampaignControllerActionDisplayUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignComponentValidationRestException,
        BuildCampaignRestException, CampaignUpdateRestException {
        Authorization authorization = authorizationProvider.getClientAuthorization(accessToken);
        ...
        FrontendController controller;
        CampaignControllerActionDisplay action;
        CampaignBuilder campaignBuilder;

        try {
            Campaign campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            controller = campaignStepProvider.getFrontendController(campaign, controllerId);
            action = campaignStepProvider.getDisplayControllerAction(campaign, controllerId, actionId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerActionDisplayBuilder actionBuilder =
                campaignBuilder.updateFrontendController(controller)
                    .updateAction(action);
    ...
    @Override
    public CampaignControllerActionDisplayResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId)
    ...
    @Override
    public CampaignControllerActionDisplayResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerActionDisplay action =
            campaignStepProvider.getDisplayControllerAction(campaign, controllerId, actionId);

        return responseMapper.toResponse(action, ZoneOffset.UTC);
    }

    @Override
    public BuiltCampaignControllerActionDisplayResponse getBuilt(String accessToken, String campaignId, String version,
        ...
        BuiltCampaignControllerActionDisplay action =
            campaignStepProvider.getDisplayBuiltControllerAction(builtCampaign, controllerId, actionId);
