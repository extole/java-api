...
import com.extole.client.rest.campaign.controller.action.approve.CampaignControllerActionApproveCreateRequest;
import com.extole.client.rest.campaign.controller.action.approve.CampaignControllerActionApproveEndpoints;
import com.extole.client.rest.campaign.controller.action.approve.CampaignControllerActionApproveResponse;
import com.extole.client.rest.campaign.controller.action.approve.CampaignControllerActionApproveUpdateRequest;
...
@Provider
public class CampaignControllerActionApproveEndpointsImpl implements CampaignControllerActionApproveEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerActionApproveResponseMapper responseMapper;
    ...
    @Autowired
    public CampaignControllerActionApproveEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerActionApproveResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerActionApproveResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerActionApproveCreateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerActionApproveValidationRestException, CampaignComponentValidationRestException,
        ...
        try {
            CampaignControllerActionApproveBuilder actionBuilder = campaignBuilder.updateController(controller)
                .addAction(CampaignControllerActionType.APPROVE);
            ...
            request.getForce().ifPresent(force -> actionBuilder.withForce(force));
            ...
            request.getRewardTags().ifPresent(rewardTags -> actionBuilder.withRewardTags(rewardTags));
    ...
    @Override
    public CampaignControllerActionApproveResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId,
        CampaignControllerActionApproveUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerActionApproveValidationRestException, CampaignComponentValidationRestException,
        BuildCampaignRestException, CampaignUpdateRestException {
        Authorization authorization = authorizationProvider.getClientAuthorization(accessToken);
        ...
        Campaign campaign;
        CampaignController controller;
        CampaignControllerActionApprove action;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            controller = campaignStepProvider.getController(campaign, controllerId);
            action = campaignStepProvider.getApproveControllerAction(campaign, controllerId, actionId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerActionApproveBuilder actionBuilder =
    ...
    @Override
    public CampaignControllerActionApproveResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId)
    ...
    @Override
    public CampaignControllerActionApproveResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerActionApprove action =
            campaignStepProvider.getApproveControllerAction(campaign, controllerId, actionId);
