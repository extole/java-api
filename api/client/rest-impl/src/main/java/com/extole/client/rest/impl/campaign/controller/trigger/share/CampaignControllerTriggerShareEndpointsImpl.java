...
import com.extole.client.rest.campaign.controller.trigger.share.CampaignControllerTriggerShareCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.share.CampaignControllerTriggerShareEndpoints;
import com.extole.client.rest.campaign.controller.trigger.share.CampaignControllerTriggerShareResponse;
import com.extole.client.rest.campaign.controller.trigger.share.CampaignControllerTriggerShareUpdateRequest;
import com.extole.client.rest.campaign.controller.trigger.share.CampaignControllerTriggerShareValidationRestException;
...
import com.extole.model.service.campaign.controller.trigger.share.CampaignControllerTriggerShareMissingChannelsException;
import com.extole.model.service.campaign.step.CampaignStepBuildException;

@Provider
public class CampaignControllerTriggerShareEndpointsImpl implements CampaignControllerTriggerShareEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerShareResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerShareEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerShareResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerShareResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerShareCreateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerTriggerShareValidationRestException, CampaignControllerTriggerValidationRestException,
        ...
        try {
            CampaignControllerTriggerShareBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
                .addTrigger(CampaignControllerTriggerType.SHARE);
            ...
            triggerBuilder
                .withChannels(request.getChannels().stream()
                    .map(shareType -> CampaignControllerTriggerShareChannel.valueOf(shareType.name()))
                    .collect(Collectors.toSet()));

            if (request.getQuality() != null) {
                triggerBuilder.withQuality(ShareQuality.valueOf(request.getQuality().name()));
            }
            ...
            throw RestExceptionBuilder.newBuilder(CampaignUpdateRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerShareMissingChannelsException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerShareValidationRestException.class)
                .withErrorCode(CampaignControllerTriggerShareValidationRestException.MISSING_CHANNELS)
                .withCause(e)
                .build();
    ...
    @Override
    public CampaignControllerTriggerShareResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerShareUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerShare trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getShareStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerShareBuilder triggerBuilder =
            ...
            if (request.getChannels() != null && !request.getChannels().isEmpty()) {
                triggerBuilder.withChannels(request.getChannels().stream()
                    .map(shareType -> CampaignControllerTriggerShareChannel.valueOf(shareType.name()))
                    .collect(Collectors.toSet()));
            }
            if (request.getQuality() != null) {
    ...
    @Override
    public CampaignControllerTriggerShareResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
    ...
    @Override
    public CampaignControllerTriggerShareResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerTriggerShare trigger =
            campaignStepProvider.getShareStepTrigger(campaign, controllerId, triggerId);
