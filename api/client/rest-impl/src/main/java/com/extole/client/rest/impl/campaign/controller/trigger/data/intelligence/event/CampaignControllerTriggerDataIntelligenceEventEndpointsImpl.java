...
import static com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventValidationRestException.EVENT_NAME_LENGTH_OUT_OF_RANGE;
import static com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventValidationRestException.INVALID_EVENT_NAME;
import static com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventValidationRestException.MISSING_EVENT_NAME;
import static com.extole.common.rest.exception.FatalRestRuntimeException.SOFTWARE_ERROR;
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.DATA_INTELLIGENCE_EVENT;
...
import com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventEndpoints;
...
import com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventUpdateRequest;
import com.extole.client.rest.campaign.controller.trigger.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventValidationRestException;
...
import com.extole.model.service.campaign.controller.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventIllegalCharacterInEventNameException;
import com.extole.model.service.campaign.controller.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventMissingEventNameException;
import com.extole.model.service.campaign.controller.data.intelligence.event.CampaignControllerTriggerDataIntelligenceEventNameLengthException;
...
@Provider
public class CampaignControllerTriggerDataIntelligenceEventEndpointsImpl
    implements CampaignControllerTriggerDataIntelligenceEventEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerDataIntelligenceEventResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerDataIntelligenceEventEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerDataIntelligenceEventResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerDataIntelligenceEventResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerDataIntelligenceEventCreateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerTriggerDataIntelligenceEventValidationRestException,
        ...
        try {
            CampaignControllerTriggerDataIntelligenceEventBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
                .addTrigger(DATA_INTELLIGENCE_EVENT);

            request.getTriggerPhase()
                .ifPresent(phase -> triggerBuilder
                    .withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));

            triggerBuilder.withEventName(request.getEventName());
            ...
            throw RestExceptionBuilder.newBuilder(CampaignUpdateRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerDataIntelligenceEventIllegalCharacterInEventNameException e) {
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerTriggerDataIntelligenceEventValidationRestException.class)
                .withErrorCode(INVALID_EVENT_NAME)
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerDataIntelligenceEventNameLengthException e) {
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerTriggerDataIntelligenceEventValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerDataIntelligenceEventMissingEventNameException e) {
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerTriggerDataIntelligenceEventValidationRestException.class)
                .withErrorCode(MISSING_EVENT_NAME)
                .withCause(e)
                .build();
    ...
    @Override
    public CampaignControllerTriggerDataIntelligenceEventResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerDataIntelligenceEventUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerTriggerDataIntelligenceEventValidationRestException,
        CampaignControllerTriggerValidationRestException, CampaignComponentValidationRestException,
        BuildCampaignRestException, CampaignUpdateRestException {
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerDataIntelligenceEvent trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getDataIntelligenceEventStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerDataIntelligenceEventBuilder triggerBuilder =
            ...
            request.getEventName().ifPresent(eventName -> triggerBuilder.withEventName(eventName));
            request.getName().ifPresent(name -> triggerBuilder.withName(name));
            request.getDescription().ifPresent(description -> triggerBuilder.withDescription(description));
            request.getEnabled().ifPresent(enabled -> triggerBuilder.withEnabled(enabled));
            request.getNegated().ifPresent(negated -> triggerBuilder.withNegated(negated));
    ...
    @Override
    public CampaignControllerTriggerDataIntelligenceEventResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerDataIntelligenceEventResponse get(String accessToken,
        String campaignId,
        String version,
        String controllerId,
        String triggerId)
        ...
        CampaignControllerTriggerDataIntelligenceEvent trigger =
            campaignStepProvider.getDataIntelligenceEventStepTrigger(campaign, controllerId, triggerId);
