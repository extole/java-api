...
@Component
public class CampaignControllerTriggerTargetingUploader
    implements CampaignControllerTriggerUploader<CampaignControllerTriggerTargetingConfiguration> {

    @Override
    public void upload(CampaignUploadContext context,
        CampaignStepConfiguration step, CampaignControllerTriggerTargetingConfiguration trigger,
        ZoneId timeZone) throws CampaignComponentValidationRestException {
        CampaignControllerTriggerTargetingBuilder triggerBuilder = context.get(step, trigger);
        ...
        trigger.getScope()
            .ifDefined((value) -> triggerBuilder.withScope(Evaluatables.remapEnum(value, new TypeReference<>() {})));
