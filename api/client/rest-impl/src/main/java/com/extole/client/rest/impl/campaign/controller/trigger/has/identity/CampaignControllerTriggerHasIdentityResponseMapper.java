...
@Component
public class CampaignControllerTriggerHasIdentityResponseMapper implements
    CampaignControllerTriggerResponseMapper<CampaignControllerTriggerHasIdentity,
        CampaignControllerTriggerHasIdentityResponse, CampaignControllerTriggerHasIdentityConfiguration> {

    private final CampaignComponentRestMapper campaignComponentRestMapper;

    @Autowired
    public CampaignControllerTriggerHasIdentityResponseMapper(
        CampaignComponentRestMapper campaignComponentRestMapper) {
        this.campaignComponentRestMapper = campaignComponentRestMapper;
    }

    @Override
    public CampaignControllerTriggerHasIdentityResponse toResponse(CampaignControllerTriggerHasIdentity trigger,
        ZoneId timeZone) {
        return new CampaignControllerTriggerHasIdentityResponse(trigger.getId().getValue(),
    ...
    @Override
    public CampaignControllerTriggerHasIdentityConfiguration toConfiguration(
        CampaignControllerTriggerHasIdentity trigger, ZoneId timeZone,
        Map<Id<CampaignComponent>, String> componentNames) {
        return new CampaignControllerTriggerHasIdentityConfiguration(
