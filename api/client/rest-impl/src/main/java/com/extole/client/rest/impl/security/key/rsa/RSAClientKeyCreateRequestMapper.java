...
import com.extole.client.rest.security.key.GenericClientKeyCreateRequest;
...
@Component
public class RSAClientKeyCreateRequestMapper
    extends BaseClientKeyCreateRequestMapper<GenericClientKeyCreateRequest, ClientKey> {

    @Autowired
    public RSAClientKeyCreateRequestMapper(ClientKeyService clientKeyService, ComponentService componentService,
