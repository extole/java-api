...
@Component
public class BuiltCampaignControllerActionDisplayResponseMapper implements
    BuiltCampaignControllerActionResponseMapper<BuiltCampaignControllerActionDisplay,
        BuiltCampaignControllerActionDisplayResponse> {

    @Override
    public BuiltCampaignControllerActionDisplayResponse toResponse(BuiltCampaignControllerActionDisplay action,
        ZoneId timeZone) {
        return new BuiltCampaignControllerActionDisplayResponse(
