...
import com.extole.client.rest.security.key.built.BuiltOAuthOptimoveClientKeyResponse;
import com.extole.id.Id;
import com.extole.model.entity.client.security.key.ClientKey;
import com.extole.model.entity.client.security.key.built.BuiltOAuthOptimoveClientKey;
import com.extole.model.service.encryption.EncryptionService;

@Component
public class BuiltOAuthOptimoveClientKeyResponseMapper
    extends BuiltBaseClientKeyResponseMapper<BuiltOAuthOptimoveClientKey, BuiltOAuthOptimoveClientKeyResponse> {

    @Autowired
    public BuiltOAuthOptimoveClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public BuiltOAuthOptimoveClientKeyResponse toResponse(BuiltOAuthOptimoveClientKey clientKey, ZoneId timeZone) {
        return new BuiltOAuthOptimoveClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
    ...
    public ClientKey.Algorithm getAlgorithm() {
        return ClientKey.Algorithm.OAUTH_OPTIMOVE;
    }
