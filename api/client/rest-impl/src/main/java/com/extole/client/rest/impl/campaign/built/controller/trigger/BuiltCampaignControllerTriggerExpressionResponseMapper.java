...
@Component
public class BuiltCampaignControllerTriggerExpressionResponseMapper implements
    BuiltCampaignControllerTriggerResponseMapper<BuiltCampaignControllerTriggerExpression,
        BuiltCampaignControllerTriggerExpressionResponse> {

    @Override
    public BuiltCampaignControllerTriggerExpressionResponse toResponse(BuiltCampaignControllerTriggerExpression trigger,
        ZoneId timeZone) {
        return new BuiltCampaignControllerTriggerExpressionResponse(trigger.getId().getValue(),
