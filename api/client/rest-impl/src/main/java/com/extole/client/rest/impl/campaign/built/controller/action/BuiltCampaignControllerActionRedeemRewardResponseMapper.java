...
import com.extole.model.entity.campaign.built.BuiltCampaignControllerActionRedeemReward;

@Component
public class BuiltCampaignControllerActionRedeemRewardResponseMapper implements
    BuiltCampaignControllerActionResponseMapper<BuiltCampaignControllerActionRedeemReward,
        BuiltCampaignControllerActionRedeemRewardResponse> {

    @Override
    public BuiltCampaignControllerActionRedeemRewardResponse
        toResponse(BuiltCampaignControllerActionRedeemReward action, ZoneId timeZone) {
        return new BuiltCampaignControllerActionRedeemRewardResponse(
