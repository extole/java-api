...
import com.extole.client.rest.campaign.controller.trigger.targeting.CampaignControllerTriggerTargetingCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.targeting.CampaignControllerTriggerTargetingEndpoints;
import com.extole.client.rest.campaign.controller.trigger.targeting.CampaignControllerTriggerTargetingResponse;
import com.extole.client.rest.campaign.controller.trigger.targeting.CampaignControllerTriggerTargetingUpdateRequest;
...
import com.extole.client.rest.impl.campaign.built.controller.trigger.BuiltCampaignControllerTriggerTargetingResponseMapper;
...
@Provider
public class CampaignControllerTriggerTargetingEndpointsImpl
    implements CampaignControllerTriggerTargetingEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerTargetingResponseMapper responseMapper;
    private final BuiltCampaignControllerTriggerTargetingResponseMapper builtResponseMapper;
    ...
    @Inject
    public CampaignControllerTriggerTargetingEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerTargetingResponseMapper responseMapper,
        BuiltCampaignControllerTriggerTargetingResponseMapper builtResponseMapper,
    ...
    @Override
    public CampaignControllerTriggerTargetingResponse create(
        String accessToken,
        String campaignId,
        ...
        try {
            CampaignStepBuilder<?, ?> controllerBuilder = campaignBuilder
                .updateStep(step);
            CampaignControllerTriggerTargetingBuilder triggerBuilder = controllerBuilder
                .addTrigger(CampaignControllerTriggerType.TARGETING);
            ...
            request.getScope().ifPresent(
                (value) -> triggerBuilder.withScope(Evaluatables.remapEnum(value, new TypeReference<>() {})));
    ...
    @Override
    public CampaignControllerTriggerTargetingResponse update(
        String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerTargeting trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getTargetingStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignStepBuilder<?, ?> controllerBuilder = campaignBuilder
                .updateStep(step);
            CampaignControllerTriggerTargetingBuilder triggerBuilder =
                controllerBuilder.updateTrigger(trigger);
    ...
    @Override
    public CampaignControllerTriggerTargetingResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
    ...
    @Override
    public CampaignControllerTriggerTargetingResponse get(String accessToken, String campaignId,
        ...
        CampaignControllerTriggerTargeting trigger =
            campaignStepProvider.getTargetingStepTrigger(campaign, controllerId, triggerId);

        return responseMapper.toResponse(trigger, ZoneOffset.UTC);
    }

    @Override
    public BuiltCampaignControllerTriggerTargetingResponse getBuilt(String accessToken, String campaignId,
        String version, String controllerId, String triggerId)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        BuildCampaignRestException {
        Authorization authorization = authorizationProvider.getClientAuthorization(accessToken);
        Campaign campaign = campaignProvider.getCampaign(authorization, Id.valueOf(campaignId), version);
        BuiltCampaignControllerTriggerTargeting trigger =
            campaignStepProvider.getTargetingBuiltStepTrigger(
