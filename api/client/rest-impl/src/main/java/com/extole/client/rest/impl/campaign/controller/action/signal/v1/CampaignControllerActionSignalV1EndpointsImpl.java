...
import com.extole.client.rest.campaign.controller.action.signal.v1.CampaignControllerActionSignalV1CreateRequest;
import com.extole.client.rest.campaign.controller.action.signal.v1.CampaignControllerActionSignalV1Endpoints;
import com.extole.client.rest.campaign.controller.action.signal.v1.CampaignControllerActionSignalV1Response;
import com.extole.client.rest.campaign.controller.action.signal.v1.CampaignControllerActionSignalV1UpdateRequest;
import com.extole.client.rest.campaign.controller.action.signal.v1.CampaignControllerActionSignalV1ValidationRestException;
...
@Provider
public class CampaignControllerActionSignalV1EndpointsImpl implements CampaignControllerActionSignalV1Endpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerActionSignalV1ResponseMapper responseMapper;
    ...
    @Autowired
    public CampaignControllerActionSignalV1EndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerActionSignalV1ResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerActionSignalV1Response create(String accessToken,
        String campaignId,
        ...
        try {
            CampaignControllerActionSignalV1Builder actionBuilder = campaignBuilder.updateController(controller)
                .addAction(CampaignControllerActionType.SIGNAL_V1);
            ...
            request.getSignalPollingId()
                .ifPresent(signalPollingId -> actionBuilder.withSignalPollingId(signalPollingId));
            ...
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerActionSignalV1ValidationRestException.class)
                .withErrorCode(
                    CampaignControllerActionSignalV1ValidationRestException.DATA_ATTRIBUTE_NAME_INVALID)
                .withCause(e).build();
            ...
            throw RestExceptionBuilder
                ...
                .addParameter("signal_polling_id", request.getSignalPollingId())
                .withCause(e).build();
    ...
    @Override
    public CampaignControllerActionSignalV1Response update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId,
        ...
        Campaign campaign;
        CampaignController controller;
        CampaignControllerActionSignalV1 action;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            controller = campaignStepProvider.getController(campaign, controllerId);
            action = campaignStepProvider.getSignalV1ControllerAction(campaign, controllerId, actionId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerActionSignalV1Builder actionBuilder =
    ...
    @Override
    public CampaignControllerActionSignalV1Response delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId)
    ...
    @Override
    public CampaignControllerActionSignalV1Response get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerActionSignalV1 action =
            campaignStepProvider.getSignalV1ControllerAction(campaign, controllerId, actionId);
