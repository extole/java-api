...
import com.extole.client.rest.campaign.controller.action.webhook.CampaignControllerActionWebhookCreateRequest;
import com.extole.client.rest.campaign.controller.action.webhook.CampaignControllerActionWebhookEndpoints;
import com.extole.client.rest.campaign.controller.action.webhook.CampaignControllerActionWebhookResponse;
import com.extole.client.rest.campaign.controller.action.webhook.CampaignControllerActionWebhookUpdateRequest;
...
import com.extole.model.service.campaign.controller.action.webhook.CampaignControllerActionWebhookDataInvalidSyntaxException;
...
@Provider
public class CampaignControllerActionWebhookEndpointsImpl implements CampaignControllerActionWebhookEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerActionWebhookResponseMapper responseMapper;
    ...
    @Autowired
    public CampaignControllerActionWebhookEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerActionWebhookResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerActionWebhookResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerActionWebhookCreateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerActionWebhookValidationRestException, CampaignComponentValidationRestException,
        ...
        try {
            CampaignControllerActionWebhookBuilder actionBuilder = campaignBuilder.updateController(controller)
                .addAction(CampaignControllerActionType.WEBHOOK);
            ...
            request.getWebhookId().ifPresent(webhookId -> actionBuilder.withWebhookId(webhookId));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignComponentValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerActionWebhookDataInvalidSyntaxException e) {
    ...
    @Override
    public CampaignControllerActionWebhookResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId,
        CampaignControllerActionWebhookUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerActionWebhookValidationRestException, CampaignComponentValidationRestException,
        BuildCampaignRestException, CampaignUpdateRestException {
        Authorization authorization = authorizationProvider.getClientAuthorization(accessToken);
        ...
        Campaign campaign;
        CampaignController controller;
        CampaignControllerActionWebhook action;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            controller = campaignStepProvider.getController(campaign, controllerId);
            action = campaignStepProvider.getWebhookControllerAction(campaign, controllerId, actionId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerActionWebhookBuilder actionBuilder =
    ...
    @Override
    public CampaignControllerActionWebhookResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String actionId)
    ...
    @Override
    public CampaignControllerActionWebhookResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerActionWebhook action =
            campaignStepProvider.getWebhookControllerAction(campaign, controllerId, actionId);
