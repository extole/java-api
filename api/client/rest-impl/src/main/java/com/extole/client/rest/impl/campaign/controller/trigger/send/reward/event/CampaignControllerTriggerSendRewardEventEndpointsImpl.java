...
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.SEND_REWARD_EVENT;
...
import com.extole.client.rest.campaign.controller.trigger.send.reward.event.CampaignControllerTriggerSendRewardEventCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.send.reward.event.CampaignControllerTriggerSendRewardEventEndpoints;
...
@Provider
public class CampaignControllerTriggerSendRewardEventEndpointsImpl
    implements CampaignControllerTriggerSendRewardEventEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerSendRewardEventResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerSendRewardEventEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerSendRewardEventResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerSendRewardEventResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerSendRewardEventCreateRequest createRequest)
        ...
        try {
            CampaignControllerTriggerSendRewardEventBuilder triggerBuilder =
            ...
            createRequest.getTriggerPhase()
                .ifPresent(
                    phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));
            createRequest.getRewardNames().ifPresent(rewardNames -> triggerBuilder.withRewardNames(rewardNames));
            createRequest.getRewardStates()
                .ifPresent(rewardStates -> triggerBuilder
                    .withRewardStates(Evaluatables.remapEnumCollection(rewardStates, new TypeReference<>() {})));
            createRequest.getTags().ifPresent(tags -> triggerBuilder.withTags(tags));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignComponentValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerSendRewardEventRewardNameLengthException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerSendRewardEventValidationRestException.class)
                ...
                .addParameter("reward_name", e.getRewardName())
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerSendRewardEventTagInvalidException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerSendRewardEventValidationRestException.class)
    ...
    @Override
    public CampaignControllerTriggerSendRewardEventResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerSendRewardEventUpdateRequest updateRequest)
        ...
        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getSendRewardEventStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerSendRewardEventBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
            ...
            updateRequest.getTriggerPhase()
                .ifPresent(
                    phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));
            updateRequest.getRewardNames().ifPresent(rewardNames -> triggerBuilder.withRewardNames(rewardNames));
            updateRequest.getRewardStates()
                .ifPresent(rewardStates -> triggerBuilder
                    .withRewardStates(Evaluatables.remapEnumCollection(rewardStates, new TypeReference<>() {})));
            updateRequest.getTags().ifPresent(tags -> triggerBuilder.withTags(tags));
    ...
    @Override
    public CampaignControllerTriggerSendRewardEventResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerSendRewardEventResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerTriggerSendRewardEvent trigger =
            campaignStepProvider.getSendRewardEventStepTrigger(campaign, controllerId, triggerId);
