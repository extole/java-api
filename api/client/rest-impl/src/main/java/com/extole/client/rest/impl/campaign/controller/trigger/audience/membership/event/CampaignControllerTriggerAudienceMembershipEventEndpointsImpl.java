...
import static com.extole.client.rest.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventValidationRestException.AUDIENCE_NOT_FOUND;
import static com.extole.common.rest.exception.FatalRestRuntimeException.SOFTWARE_ERROR;
import static com.extole.model.entity.campaign.CampaignControllerTriggerType.AUDIENCE_MEMBERSHIP_EVENT;
...
import com.extole.client.rest.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventEndpoints;
...
import com.extole.client.rest.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventUpdateRequest;
import com.extole.client.rest.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventValidationRestException;
...
import com.extole.model.service.campaign.controller.trigger.audience.membership.event.CampaignControllerTriggerAudienceMembershipEventInvalidAudienceIdException;
import com.extole.model.service.campaign.step.CampaignStepBuildException;

@Provider
public class CampaignControllerTriggerAudienceMembershipEventEndpointsImpl
    implements CampaignControllerTriggerAudienceMembershipEventEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerAudienceMembershipEventResponseMapper responseMapper;
    ...
    @Inject
    public CampaignControllerTriggerAudienceMembershipEventEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerAudienceMembershipEventResponseMapper responseMapper,
    ...
    @Override
    public CampaignControllerTriggerAudienceMembershipEventResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerAudienceMembershipEventCreateRequest createRequest)
        ...
        try {
            CampaignControllerTriggerAudienceMembershipEventBuilder triggerBuilder =
                campaignBuilder.updateStep(step)
                    .addTrigger(AUDIENCE_MEMBERSHIP_EVENT);
            ...
            createRequest.getEventTypes().ifPresent(
                eventTypes -> triggerBuilder
                    .withEventTypes(Evaluatables.remapEnumCollection(eventTypes, new TypeReference<>() {})));
            createRequest.getAudienceIds().ifPresent(audienceIds -> triggerBuilder.withAudienceIds(audienceIds));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignComponentValidationRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerAudienceMembershipEventInvalidAudienceIdException e) {
            throw RestExceptionBuilder
                .newBuilder(CampaignControllerTriggerAudienceMembershipEventValidationRestException.class)
    ...
    @Override
    public CampaignControllerTriggerAudienceMembershipEventResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerAudienceMembershipEventUpdateRequest updateRequest)
        ...
        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getAudienceMembershipEventStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignControllerTriggerAudienceMembershipEventBuilder triggerBuilder = campaignBuilder
                .updateStep(step)
            ...
            updateRequest.getTriggerPhase().ifPresent(
                phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));
            updateRequest.getEventTypes().ifPresent(
                eventTypes -> triggerBuilder
                    .withEventTypes(Evaluatables.remapEnumCollection(eventTypes, new TypeReference<>() {})));
            updateRequest.getAudienceIds().ifPresent(audienceIds -> triggerBuilder.withAudienceIds(audienceIds));
    ...
    @Override
    public CampaignControllerTriggerAudienceMembershipEventResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId)
    ...
    @Override
    public CampaignControllerTriggerAudienceMembershipEventResponse get(String accessToken,
        String campaignId,
        String version,
        String controllerId,
        String triggerId)
        ...
        CampaignControllerTriggerAudienceMembershipEvent trigger =
            campaignStepProvider.getAudienceMembershipEventStepTrigger(campaign, controllerId, triggerId);
