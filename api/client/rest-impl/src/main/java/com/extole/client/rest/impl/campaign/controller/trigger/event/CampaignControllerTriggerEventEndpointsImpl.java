...
import com.extole.client.rest.campaign.controller.trigger.event.CampaignControllerTriggerEventCreateRequest;
import com.extole.client.rest.campaign.controller.trigger.event.CampaignControllerTriggerEventEndpoints;
import com.extole.client.rest.campaign.controller.trigger.event.CampaignControllerTriggerEventResponse;
import com.extole.client.rest.campaign.controller.trigger.event.CampaignControllerTriggerEventUpdateRequest;
...
import com.extole.client.rest.impl.campaign.built.controller.trigger.BuiltCampaignControllerTriggerEventResponseMapper;
...
import com.extole.model.service.campaign.controller.trigger.event.CampaignControllerTriggerEventMissingEventNameException;
import com.extole.model.service.campaign.controller.trigger.event.CampaignControllerTriggerEventReservedEventNameException;
...
@Provider
public class CampaignControllerTriggerEventEndpointsImpl implements CampaignControllerTriggerEventEndpoints {

    private final ClientAuthorizationProvider authorizationProvider;
    private final CampaignStepProvider campaignStepProvider;
    private final CampaignService campaignService;
    private final CampaignControllerTriggerEventResponseMapper responseMapper;
    private final BuiltCampaignControllerTriggerEventResponseMapper builtResponseMapper;
    ...
    @Inject
    public CampaignControllerTriggerEventEndpointsImpl(
        ClientAuthorizationProvider authorizationProvider,
        CampaignStepProvider campaignStepProvider,
        CampaignService campaignService,
        CampaignControllerTriggerEventResponseMapper responseMapper,
        BuiltCampaignControllerTriggerEventResponseMapper builtResponseMapper,
    ...
    @Override
    public CampaignControllerTriggerEventResponse create(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        CampaignControllerTriggerEventCreateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerTriggerEventValidationRestException, CampaignControllerTriggerValidationRestException,
        ...
        try {
            CampaignStepBuilder<?, ?> controllerBuilder = campaignBuilder
                .updateStep(step);
            CampaignControllerTriggerEventBuilder triggerBuilder = controllerBuilder
                .addTrigger(CampaignControllerTriggerType.EVENT);
            request.getTriggerPhase()
                .ifPresent(
                    phase -> triggerBuilder.withTriggerPhase(Evaluatables.remapEnum(phase, new TypeReference<>() {})));

            request.getEventNames().ifDefined((value) -> triggerBuilder.withEventNames(value));
            ...
            throw RestExceptionBuilder.newBuilder(CampaignUpdateRestException.class)
                ...
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerEventMissingEventNameException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerEventValidationRestException.class)
                .withErrorCode(CampaignControllerTriggerEventValidationRestException.MISSING_EVENT_NAME)
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerEventReservedEventNameException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerEventValidationRestException.class)
                .withErrorCode(
                    CampaignControllerTriggerEventValidationRestException.RESERVED_EVENT_NAME_FOR_NOT_FOUND_PAGE)
                .addParameter("event_name", e.getReservedEventName())
                .withCause(e)
                .build();
        } catch (CampaignControllerTriggerEventUnsupportedEventTypeException e) {
            throw RestExceptionBuilder.newBuilder(CampaignControllerTriggerEventValidationRestException.class)
                .withErrorCode(CampaignControllerTriggerEventValidationRestException.UNSUPPORTED_EVENT_TYPE)
                .addParameter("event_type", e.getEventType())
                .addParameter("allowed_event_types", e.getAllowedEventTypes())
                .withCause(e)
                .build();
    ...
    @Override
    public CampaignControllerTriggerEventResponse update(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
        String triggerId,
        CampaignControllerTriggerEventUpdateRequest request)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        CampaignControllerTriggerEventValidationRestException, CampaignControllerTriggerValidationRestException,
        CampaignComponentValidationRestException, BuildCampaignRestException, CampaignUpdateRestException,
        BuildCampaignControllerRestException {
        ...
        Campaign campaign;
        CampaignStep step;
        CampaignControllerTriggerEvent trigger;
        CampaignBuilder campaignBuilder;

        try {
            campaign = campaignProvider.getLatestCampaign(authorization, Id.valueOf(campaignId));
            step = campaignStepProvider.getStep(campaign, controllerId);
            trigger = campaignStepProvider.getEventStepTrigger(campaign, controllerId, triggerId);
            campaignBuilder = campaignService.editCampaign(authorization, Id.valueOf(campaignId));
            campaignProvider.parseVersion(expectedCurrentVersion)
                .ifPresent(campaignBuilder::withExpectedVersion);
        } catch (CampaignNotFoundException e) {
        ...
        try {
            CampaignStepBuilder<?, ?> controllerBuilder = campaignBuilder
                .updateStep(step);
            CampaignControllerTriggerEventBuilder triggerBuilder = controllerBuilder.updateTrigger(trigger);
            ...
            request.getEventType().ifPresent(
                (value) -> triggerBuilder.withEventType(Evaluatables.remapEnum(value, new TypeReference<>() {})));
            request.getName().ifPresent(name -> triggerBuilder.withName(name));
            request.getParentTriggerGroupName()
                .ifPresent(parentTriggerGroupName -> triggerBuilder.withParentTriggerGroupName(parentTriggerGroupName));
    ...
    @Override
    public CampaignControllerTriggerEventResponse delete(String accessToken,
        String campaignId,
        String expectedCurrentVersion,
        String controllerId,
    ...
    @Override
    public CampaignControllerTriggerEventResponse get(String accessToken, String campaignId, String version,
        ...
        CampaignControllerTriggerEvent trigger =
            campaignStepProvider.getEventStepTrigger(campaign, controllerId, triggerId);

        return responseMapper.toResponse(trigger, ZoneOffset.UTC);
    }

    @Override
    public BuiltCampaignControllerTriggerEventResponse getBuilt(String accessToken, String campaignId, String version,
        String controllerId, String triggerId)
        throws UserAuthorizationRestException, CampaignRestException, CampaignControllerRestException,
        BuildCampaignRestException {
        Authorization authorization = authorizationProvider.getClientAuthorization(accessToken);
        Campaign campaign = campaignProvider.getCampaign(authorization, Id.valueOf(campaignId), version);
        BuiltCampaignControllerTriggerEvent trigger =
            campaignStepProvider.getEventBuiltStepTrigger(campaignProvider.buildCampaign(campaign), controllerId,
                triggerId);
