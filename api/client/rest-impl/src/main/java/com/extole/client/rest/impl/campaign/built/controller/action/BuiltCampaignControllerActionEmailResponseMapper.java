...
public class BuiltCampaignControllerActionEmailResponseMapper implements
    ...
    @Override
    public BuiltCampaignControllerActionEmailResponse toResponse(BuiltCampaignControllerActionEmail action,
        ZoneId timeZone) {
        return new BuiltCampaignControllerActionEmailResponse(action.getId().getValue(),
