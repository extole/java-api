...
@Component
public class CampaignControllerActionRemoveMembershipResponseMapper implements
    CampaignControllerActionResponseMapper<CampaignControllerActionRemoveMembership,
        CampaignControllerActionRemoveMembershipResponse, CampaignControllerActionRemoveMembershipConfiguration> {

    private final CampaignComponentRestMapper campaignComponentRestMapper;

    @Autowired
    public CampaignControllerActionRemoveMembershipResponseMapper(
        CampaignComponentRestMapper campaignComponentRestMapper) {
        this.campaignComponentRestMapper = campaignComponentRestMapper;
    }

    @Override
    public CampaignControllerActionRemoveMembershipResponse
        toResponse(CampaignControllerActionRemoveMembership action, ZoneId timeZone) {
        return new CampaignControllerActionRemoveMembershipResponse(
    ...
    public CampaignControllerActionRemoveMembershipConfiguration
        toConfiguration(CampaignControllerActionRemoveMembership action, ZoneId timeZone,
            Map<Id<CampaignComponent>, String> componentNames) {
        return new CampaignControllerActionRemoveMembershipConfiguration(
