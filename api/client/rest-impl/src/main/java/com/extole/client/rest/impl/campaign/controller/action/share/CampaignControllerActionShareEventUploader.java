...
@Component
public class CampaignControllerActionShareEventUploader
    implements CampaignControllerActionUploader<CampaignControllerActionShareEventConfiguration> {
    ...
    public void upload(CampaignUploadContext context, CampaignStepConfiguration step,
        ...
        CampaignControllerActionBuilder<?> actionBuilder = context.get(step, action);
