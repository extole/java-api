...
import com.extole.client.rest.security.key.built.BuiltOAuthLeadPerfectionClientKeyResponse;
import com.extole.id.Id;
import com.extole.model.entity.client.security.key.ClientKey;
import com.extole.model.entity.client.security.key.built.BuiltOAuthLeadPerfectionClientKey;
import com.extole.model.service.encryption.EncryptionService;

@Component
public class BuiltOAuthLeadPerfectionClientKeyResponseMapper
    extends
    BuiltBaseClientKeyResponseMapper<BuiltOAuthLeadPerfectionClientKey, BuiltOAuthLeadPerfectionClientKeyResponse> {

    @Autowired
    public BuiltOAuthLeadPerfectionClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public BuiltOAuthLeadPerfectionClientKeyResponse toResponse(BuiltOAuthLeadPerfectionClientKey clientKey,
        ZoneId timeZone) {
        return new BuiltOAuthLeadPerfectionClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
            ...
            clientKey.getScope(),
            clientKey.getLeadPerfectionClientId(),
            clientKey.getAppKey(),
            clientKey.getTags(),
    ...
    public ClientKey.Algorithm getAlgorithm() {
        return ClientKey.Algorithm.OAUTH_LEAD_PERFECTION;
    }
