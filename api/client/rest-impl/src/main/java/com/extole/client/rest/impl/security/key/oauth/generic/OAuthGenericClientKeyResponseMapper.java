...
@Component
public class OAuthGenericClientKeyResponseMapper
    extends BaseClientKeyResponseMapper<OAuthGenericClientKey, OAuthGenericClientKeyResponse> {

    @Autowired
    public OAuthGenericClientKeyResponseMapper(EncryptionService<byte[]> encryptionService) {
        super(encryptionService);
    }

    @Override
    public OAuthGenericClientKeyResponse toResponse(OAuthGenericClientKey clientKey, ZoneId timeZone) {
        return new OAuthGenericClientKeyResponse(clientKey.getId().getValue(),
            clientKey.getName(),
